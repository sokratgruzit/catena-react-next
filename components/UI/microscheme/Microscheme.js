...
const Microscheme = props => {
    ...
    let animateLines = (array) => {
        ...
        if(array.length !== 0){
            fullRange = Array.from({ length: 12 }, (_, i) => i + 1);
            ...
            <svg width='1440' height='1024' viewBox='0 0 1440 1024' fill='none'>
                <g clipPath='url(#clip0_110_2)'>
                    ...
                    <circle
                        ...
                        strokeWidth='1.5'
                    />
                    <path className={`${styles.delay3} ${styles.line}  line10`} d='M710 995.5L790.5 995.5L811 975.5L811 969' stroke='#A6D0DD' />
                    <circle
                    ...
                    <g opacity='0.4'>
                        ...
                        />
                        <circle
                            className={`${styles.delay5} ${styles.opacity} circle9`}
                            cx='568'
                            cy='732'
                            r='4'
                    ...
                    <g opacity='0.4'>
                        <circle
                            className={`${styles.delay5} ${styles.opacity} circle7`}
                            cx='41'
                            cy='930'
                            r='4'
                    ...
                    />
                    <circle
                        className={`${styles.delay5} ${styles.opacityH} circle7`}
                        opacity='0.3'
                        cx='54'
                        cy='882'
                        r='4'
                        ...
                        fill='#162029'
                    />
                    <circle className={`${styles.delay4} ${styles.opacityH} circle8`}opacity='0.3' cx='143' cy='439' r='3' fill='#162029' />
                    <circle className={`${styles.delay3} ${styles.opacityH} circle8`}opacity='0.4' cx='153' cy='439' r='3' fill='#162029' />
                    <circle className={`${styles.delay2} ${styles.opacityH} circle8`}opacity='0.3' cx='163' cy='439' r='3' fill='#162029' />
                    <circle className={`${styles.delay1} ${styles.opacityH} circle8`} opacity='0.3' cx='173' cy='439' r='3' fill='#162029' />
                    <circle
                    ...
                    />
                    <circle
                        className={`${styles.delay4} ${styles.opacityH} circle8`}
                        opacity='0.3'
                        cx='309'
                        cy='557'
                        r='3'
                    ...
                    <circle
                        ...
                        fill='#162029'
                    />
                    <circle className={`${styles.delay1} ${styles.opacityH} circle11`} opacity='0.3' cx='1086' cy='784' r='3' transform='rotate(-90 1086 784)' fill='#162029' />
                    <circle className={`${styles.delay2} ${styles.opacityH} circle11`} opacity='0.4' cx='1086' cy='774' r='3' transform='rotate(-90 1086 774)' fill='#162029' />
                    <circle className={`${styles.delay3} ${styles.opacityH} circle11`} opacity='0.3' cx='1086' cy='764' r='3' transform='rotate(-90 1086 764)' fill='#162029' />
                    <circle className={`${styles.delay4} ${styles.opacityH} circle11`} opacity='0.3' cx='1086' cy='754' r='3' transform='rotate(-90 1086 754)' fill='#162029' />
                    </g>
                    <g opacity='0.4'>
                    ...
                    <g opacity='0.4'>
                        <circle className={`${styles.delay4} ${styles.opacity} circle10`} cx='885' cy='684' r='2.25' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle10`} cx='885' cy='720' r='2.25' stroke='#162029' strokeWidth='1.5' />
                        <path className={`${styles.delay5} ${styles.line}  line10`} d='M885 686.5C885 712.1 885 718.5 885 718.5' stroke='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle className={`${styles.delay1} ${styles.opacity} circle10`} cx='876' cy='675' r='2.25' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle10`} cx='876' cy='691' r='2.25' stroke='#162029' strokeWidth='1.5' />
                        <path className={`${styles.delay3} ${styles.line}  line10`} d='M876 678C876 686.8 876 689 876 689' stroke='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle
                            className={`${styles.delay4} ${styles.opacity} circle9`}
                    ...
                    <path className={`${styles.delay3} ${styles.opacityH} circle12`} opacity='0.4' d='M1319 581L1176 581' stroke='url(#paint25_linear_110_2)' />
                    <path className={`${styles.delay2} ${styles.opacityH} circle12`} opacity='0.4' d='M1258 589L1209 589' stroke='#162029' />
                    <path className={`${styles.delay1} ${styles.opacityH} circle12`} d='M1271 573L1165 573' stroke='#FF6969' />
                    {/*<path className={`${styles.delay2} ${styles.opacityH} circle12`} opacity='0.4' d='M63 426L63 450' stroke='#162029' />*/}
                    {/*<path className={`${styles.delay1} ${styles.opacityH} circle12`} opacity='0.4' d='M58 426L58 448' stroke='#162029' />*/}
                    <path
                        className={`${styles.delay3} ${styles.line}  line9`}
                        d='M625 750L625 806'
                    ...
                    />
                    <path
                        className={`${styles.delay1} ${styles.line}  line9`}
                        opacity='0.4'
                        d='M629 750L629 808'
                    ...
                    />
                    <path
                        className={`${styles.delay1} ${styles.opacityH} circle9`}
                        opacity='0.4'
                        d='M492 521L492 532'
                    ...
                    <path className={`${styles.delay5} ${styles.line}  line10`} d='M795.5 804L795.5 723.5L815.5 703L822 703' stroke='url(#paint41_linear_110_2)' />
                    <circle className={`${styles.delay4} ${styles.opacity} circle10`} cx='824' cy='703' r='2.25' transform='rotate(-90 824 703)' stroke='#ACCAD6' strokeWidth='1.5' />
                    <circle className={`${styles.delay3} ${styles.opacity} circle10`} cx='796' cy='806' r='2.25' transform='rotate(-90 796 806)' stroke='#FD6C6D' strokeWidth='1.5' />
                    <g opacity='0.4'>
                        <circle className={`${styles.delay1} ${styles.opacity} circle10`} cx='767' cy='749' r='2.25' transform='rotate(-90 767 749)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle10`} cx='784' cy='749' r='2.25' transform='rotate(-90 784 749)' stroke='#162029' strokeWidth='1.5' />
                        <path
                    ...
                    <g opacity='0.4'>
                        <path className={`${styles.delay5} ${styles.line}  line10`} d='M786.5 824.5L786.5 775L773 764L754 764' stroke='#162029' />
                        <path
                    ...
                    <g opacity='0.4'>
                        ...
                        />
                        <path
                            className={`${styles.delay5} ${styles.line}  line10`}
                    ...
                    <g opacity='0.3'>
                        <path className={`${styles.delay5} ${styles.line}  line11`} d='M1142.5 969L1054 969L1039 984' stroke='black' />
                        <path
                    ...
                    <path className={`${styles.delay3} ${styles.line}  line11`} d='M1142 970H1053L1038 985' stroke='white' />
                    <path
                        className={`${styles.delay2} ${styles.opacity} circle11`}
                    ...
                    <g opacity='0.4'>
                        <path
                            ...
                            fill='#162029'
                        />
                        <path className={`${styles.delay5} ${styles.line}  line12`} d='M1379.51 922.5V871.5L1394.01 857V765' stroke='#162029' />
                    </g>
                    <path className={`${styles.delay3} ${styles.line}  line11`} d='M1185 948.5L1094.5 948.5L1079.5 936L1045 936' stroke='url(#paint44_linear_110_2)' />
                    <path
                        className={`${styles.delay2} ${styles.opacity} circle11`}
                    ...
                    <path
                        ...
                        fill='#CBC3BA'
                    />
                    <path className={`${styles.delay5} ${styles.line}  line11`} d='M1138.5 716L1138.5 625.5L1151 610.5L1151 576' stroke='url(#paint45_linear_110_2)' />
                    <path
                    ...
                    <path
                        ...
                        fill='#CBC3BA'
                    />
                    <path className={`${styles.delay3} ${styles.line}  line12`} d='M1395.5 711.5L1395.5 742.5L1383 757.5L1383 792' stroke='#A6D0DD' />
                    <path
                        className={`${styles.delay2} ${styles.opacity} circle12`}
                    ...
                    <path
                        ...
                        fill='#A6D0DD'
                    />
                    <path className={`${styles.delay3} ${styles.line}  line11`} d='M1141.5 576.5L1141.5 607.5L1129 622.5L1129 657' stroke='#A6D0DD' />
                    <path
                        className={`${styles.delay2} ${styles.opacity} circle11`}
                    ...
                    <path
                        ...
                        fill='#A6D0DD'
                    />
                    <path className={`${styles.delay5} ${styles.line}  line12`} d='M1523 945L1458 945L1445 957L1384.5 957' stroke='url(#paint46_linear_110_2)' />
                    <path
                        className={`${styles.delay4} ${styles.opacity} circle12`}
                    ...
                    <g opacity='0.2'>
                        ...
                        <path
                            ...
                            fill='black'
                        />
                        <path className={`${styles.delay4} ${styles.line}  line11`} d='M1264.5 957L1049 957L1033 972.5L992 972.5' stroke='black' />
                    </g>
                    <path className={`${styles.delay3} ${styles.line}  line12`} d='M1427 944H1358.5L1323 979V987' stroke='url(#paint47_linear_110_2)' />
                    <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1326 987)' stroke='#A7D1DE' strokeWidth='1.5' />
                    <circle className={`${styles.delay1} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1432 941)' stroke='#9E9C97' strokeWidth='1.5' />
                    <g opacity='0.4'>
                        <circle className={`${styles.delay1} ${styles.opacity} circle12`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1310 934)' fill='#162029' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1298 934)' fill='#162029' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle12`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1286 934)' fill='#162029' />
                        <circle className={`${styles.delay4} ${styles.opacity} circle12`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1274 934)' fill='#162029' />
                        <circle className={`${styles.delay5} ${styles.opacity} circle12`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1262 934)' fill='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle className={`${styles.delay5} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 945 776)' fill='#162029' />
                        <circle className={`${styles.delay4} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 933 776)' fill='#162029' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 921 776)' fill='#162029' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 909 776)' fill='#162029' />
                        <circle className={`${styles.delay1} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 897 776)' fill='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle className={`${styles.delay5} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 945 789)' fill='#162029' />
                        <circle className={`${styles.delay4} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 933 789)' fill='#162029' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 921 789)' fill='#162029' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 909 789)' fill='#FF6969' />
                        <circle className={`${styles.delay1} ${styles.opacity} circle10`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 897 789)' fill='#162029' />
                    </g>
                    <circle
                    ...
                    <circle
                        ...
                        fill='#162029'
                    />
                    <circle className={`${styles.delay1} ${styles.opacityH} circle12`} cx='3' cy='3' r='3' transform='matrix(4.37114e-08 -1 -1 -4.37114e-08 1418 772)' fill='#A6D0DD' />
                    <g opacity='0.4'>
                        <circle className={`${styles.delay3} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1266 880)' stroke='#FF6969' strokeWidth='1.5' />
                        <circle className={`${styles.delay4} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1266 916)' stroke='#FF6969' strokeWidth='1.5' />
                        <path className={`${styles.delay5} ${styles.line}  line12`} d='M1263 885.5C1263 911.1 1263 917.5 1263 917.5' stroke='#FF6969' />
                    </g>
                    <g opacity='0.4'>
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1278 888)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1278 924)' stroke='#162029' strokeWidth='1.5' />
                        <path className={`${styles.delay4} ${styles.line}  line12`} d='M1275 893.5C1275 919.1 1275 925.5 1275 925.5' stroke='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle className={`${styles.delay1} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1290 880)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1290 924)' stroke='#162029' strokeWidth='1.5' />
                        <path className={`${styles.delay3} ${styles.line}  line12`} d='M1287 886C1287 918 1287 926 1287 926' stroke='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1387 804)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle12`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1387 848)' stroke='#162029' strokeWidth='1.5' />
                        <path className={`${styles.delay4} ${styles.line}  line12`} d='M1384 810C1384 842 1384 850 1384 850' stroke='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle className={`${styles.delay2} ${styles.opacity} circle11`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1132 671)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle11`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1132 715)' stroke='#162029' strokeWidth='1.5' />
                        <path className={`${styles.delay4} ${styles.line}  line11`} d='M1129 677C1129 709 1129 717 1129 717' stroke='#162029' />
                    </g>
                    <path className={`${styles.delay1} ${styles.opacityH} circle11`} opacity='0.4' d='M965 835L965 862' stroke='#162029' />
                    <path className={`${styles.delay2} ${styles.opacityH} circle11`} opacity='0.4' d='M950 850L950 877' stroke='#162029' />
                    <path className={`${styles.delay3} ${styles.opacityH} circle11`} opacity='0.4' d='M956 835L956 883' stroke='#162029' />
                    <path
                        className={`${styles.delay1} ${styles.line}  line8`}
                        opacity='0.4'
                        d='M365 688L365 745'
                        stroke='#162029'
                    />
                    ...
                    <path
                        ...
                        stroke='#162029'
                    />
                    <path className={`${styles.delay1} ${styles.line}  line12`} opacity='0.4' d='M1308 845H1202' stroke='url(#paint48_linear_110_2)' />
                    <path className={`${styles.delay2} ${styles.line}  line12`} d='M1284 837L1235 837' stroke='url(#paint49_linear_110_2)' />
                    <path className={`${styles.delay3} ${styles.line}  line12`} d='M1297 853H1191' stroke='url(#paint50_linear_110_2)' />
                    <path
                        className={`${styles.delay3} ${styles.opacityH} circle9`}
                        opacity='0.4'
                        d='M773 933H667'
                    ...
                    />
                    <path className={`${styles.delay3} ${styles.line}  line11`} d='M1090.5 879L1090.5 798.5L1070.5 778L1064 778' stroke='url(#paint52_linear_110_2)' />
                    <circle
                        className={`${styles.delay2} ${styles.opacity} circle11`}
                        cx='3'
                        cy='3'
                    ...
                    <g opacity='0.4'>
                        ...
                        <circle
                            ...
                            strokeWidth='1.5'
                        />
                        <path className={`${styles.delay3} ${styles.line}  line11`} d='M1116 824C1106.4 824 1104 824 1104 824' stroke='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <path className={`${styles.delay4} ${styles.line}  line11`} d='M1099.5 899.5L1099.5 850L1113 839L1132 839' stroke='#162029' />
                        <path
                            className={`${styles.delay3} ${styles.opacity} circle11`}
                    ...
                    <g opacity='0.4'>
                        ...
                        <circle
                            ...
                            strokeWidth='1.5'
                        />
                        <path className={`${styles.delay3} ${styles.line}  line11`} d='M1178 906C1178 896.4 1178 894 1178 894' stroke='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <path
                            className={`${styles.delay3} ${styles.line}  line10`}
                    ...
                    <path className={`${styles.delay3} ${styles.line}  line11`} d='M1069 705C1049.8 705 1045 705 1045 705' stroke='url(#paint53_linear_110_2)' />
                    <circle className={`${styles.delay2} ${styles.opacity} circle11`} cx='1071' cy='705' r='2.25' transform='rotate(90 1071 705)' stroke='#A5CEDB' strokeWidth='1.5' />
                    <circle className={`${styles.delay1} ${styles.opacity} circle11`} cx='1043' cy='705' r='2.25' transform='rotate(90 1043 705)' stroke='#9C9B97' strokeWidth='1.5' />
                    <g opacity='0.4'>
                        <path className={`${styles.delay3} ${styles.line}  line12`} d='M1239 755C1192.6 755 1181 755 1181 755' stroke='#162029' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='1241' cy='755' r='2.25' transform='rotate(90 1241 755)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay1} ${styles.opacity} circle12`} cx='1179' cy='755' r='2.25' transform='rotate(90 1179 755)' stroke='#162029' strokeWidth='1.5' />
                    </g>
                    <g opacity='0.4'>
                        <path
                    ...
                    <g opacity='0.4'>
                        <path className={`${styles.delay3} ${styles.line}  line11`} d='M1168 907C1168 860.6 1168 849 1168 849' stroke='#162029' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle11`} cx='1168' cy='909' r='2.25' transform='rotate(180 1168 909)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay1} ${styles.opacity} circle11`} cx='1168' cy='847' r='2.25' transform='rotate(180 1168 847)' stroke='#162029' strokeWidth='1.5' />
                    </g>
                    <g opacity='0.4'>
                        <path className={`${styles.delay4} ${styles.line}  line11`} d='M1178 878C1178 831.6 1178 820 1178 820' stroke='#162029' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle11`} cx='1178' cy='880' r='2.25' transform='rotate(180 1178 880)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle11`} cx='1178' cy='818' r='2.25' transform='rotate(180 1178 818)' stroke='#162029' strokeWidth='1.5' />
                    </g>
                    <g opacity='0.3'>
                        <path className={`${styles.delay4} ${styles.line}  line12`} d='M1190 650.5H1256L1318 712.5' stroke='black' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle12`} cx='1320' cy='714' r='2.25' transform='rotate(90 1320 714)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='1188' cy='651' r='2.25' transform='rotate(90 1188 651)' stroke='#162029' strokeWidth='1.5' />
                    </g>
                    <g opacity='0.3'>
                        <path className={`${styles.delay3} ${styles.line}  line11`} d='M1048.44 785.303L1001.77 831.972L1001.77 919.653' stroke='black' />
                        <circle
                            className={`${styles.delay2} ${styles.opacity} circle11`}
                            cx='3'
                            cy='3'
                    ...
                    <g opacity='0.4'>
                        <path className={`${styles.delay3} ${styles.line}  line12`} d='M1184 658.5H1250L1312 720.5' stroke='black' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='1314' cy='722' r='2.25' transform='rotate(90 1314 722)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay1} ${styles.opacity} circle12`} cx='1182' cy='659' r='2.25' transform='rotate(90 1182 659)' stroke='#162029' strokeWidth='1.5' />
                    </g>
                    <g opacity='0.4'>
                        <path className={`${styles.delay3} ${styles.line}  line12`} d='M1364.25 648.657C1340.25 624.657 1334.25 618.657 1334.25 618.657' stroke='#162029' />
                        <circle
                            className={`${styles.delay2} ${styles.opacity} circle12`}
                            cx='1365.68'
                            cy='650.242'
                    ...
                    <g opacity='0.4'>
                        <path className={`${styles.delay4} ${styles.line}  line12`} d='M1367.25 637.657C1350.45 620.857 1346.25 616.657 1346.25 616.657' stroke='#162029' />
                        <circle
                    ...
                    <g opacity='0.4'>
                        <path className={`${styles.delay2} ${styles.line}  line12`} d='M1238.87 668C1215.11 668 1209.17 668 1209.17 668' stroke='#162029' />
                        <circle
                            className={`${styles.delay1} ${styles.opacity} circle12`}
                            cx='1241'
                            cy='668.113'
                    ...
                    <g opacity='0.3'>
                        <path className={`${styles.delay5} ${styles.line}  line12`} d='M1389.34 646.669C1356.53 613.859 1348.33 605.657 1348.33 605.657' stroke='#162029' />
                        <circle
                            className={`${styles.delay4} ${styles.opacity} circle12`}
                            cx='1390.76'
                            cy='648.083'
                    ...
                    <g opacity='0.3'>
                        <path className={`${styles.delay3} ${styles.line}  line12`} d='M1292.34 717.669C1259.53 684.859 1251.33 676.657 1251.33 676.657' stroke='#162029' />
                        <circle
                            className={`${styles.delay2} ${styles.opacity} circle12`}
                            cx='1293.76'
                            cy='719.083'
                    ...
                    <g opacity='0.3'>
                        <path className={`${styles.delay5} ${styles.line}  line12`} d='M1556 618.5L1485.5 689V739.5L1417 808.5' stroke='black' />
                        <path
                            className={`${styles.delay4} ${styles.opacity} circle12`}
                    ...
                    <g opacity='0.4'>
                        <circle className={`${styles.delay5} ${styles.opacity} circle12`} cx='1296' cy='501' r='4' transform='rotate(90 1296 501)' fill='#162029' />
                        <circle className={`${styles.delay4} ${styles.opacity} circle12`} cx='1296' cy='513' r='4' transform='rotate(90 1296 513)' fill='#162029' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle12`} cx='1296' cy='525' r='4' transform='rotate(90 1296 525)' fill='#162029' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='1296' cy='537' r='4' transform='rotate(90 1296 537)' fill='#162029' />
                        <circle className={`${styles.delay1} ${styles.opacity} circle12`} cx='1296' cy='549' r='4' transform='rotate(90 1296 549)' fill='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle className={`${styles.delay1} ${styles.opacity} circle12`} cx='1283' cy='501' r='4' transform='rotate(90 1283 501)' fill='#162029' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle12`} cx='1283' cy='513' r='4' transform='rotate(90 1283 513)' fill='#162029' />
                        <circle className={`${styles.delay3} ${styles.opacity} circle12`} cx='1283' cy='525' r='4' transform='rotate(90 1283 525)' fill='#162029' />
                        <circle className={`${styles.delay4} ${styles.opacity} circle12`} cx='1283' cy='537' r='4' transform='rotate(90 1283 537)' fill='#FF6969' />
                        <circle className={`${styles.delay5} ${styles.opacity} circle12`} cx='1283' cy='549' r='4' transform='rotate(90 1283 549)' fill='#162029' />
                    </g>
                    <g opacity='0.4'>
                    ...
                    <g opacity='0.4'>
                        <circle className={`${styles.delay1} ${styles.opacity} circle11`} cx='1017' cy='560' r='2.25' transform='rotate(90 1017 560)' stroke='#162029' strokeWidth='1.5' />
                        <circle className={`${styles.delay2} ${styles.opacity} circle11`} cx='973' cy='560' r='2.25' transform='rotate(90 973 560)' stroke='#162029' strokeWidth='1.5' />
                        <path className={`${styles.delay3} ${styles.line}  line11`} d='M1014 560C982.8 560 975 560 975 560' stroke='#162029' />
                    </g>
                    <g opacity='0.4'>
                        <circle
                            className={`${styles.delay2} ${styles.opacity} circle6`}
                    ...
                    <g opacity='0.4'>
                        <path className={`${styles.delay3} ${styles.line}  line10`} d='M941.5 552L1042 552L1054 561L1054 572.5' stroke='#162029' />
                        <path className={`${styles.delay2} ${styles.opacity} circle10`}
                    ...
                    <g opacity='0.4'>
                        <path className={`${styles.delay4} ${styles.line}  line11`} d='M1003 568C988.6 568 985 568 985 568' stroke='#162029' />
                        <circle
                            className={`${styles.delay3} ${styles.opacity} circle11`}
                            cx='3'
                            cy='3'
