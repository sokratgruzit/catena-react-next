    ...
    <div className={`${styles.mircroscheme}`}>
      <svg width='1440' height='1024' viewBox='0 0 1440 1024' fill='none'>
        <g clipPath='url(#clip0_110_2)'>
          ...
          <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`} d='M147.5 493.5H85L37 445.5V428' stroke='url(#paint0_linear_110_2)' />
          <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='37' cy='426' r='2.25' transform='rotate(180 37 426)' stroke='#9B9793' strokeWidth='1.5' />
          <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='150' cy='493.5' r='2.25' transform='rotate(180 150 493.5)' stroke='#A5CFDC' strokeWidth='1.5' />
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(3) ? styles.animate : ''}`} d='M492.5 454L581 454L596 469' stroke='black' />
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(3) ? styles.animate : ''}`} d='M493 455H582L597 470' stroke='white' />
          <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay3} ${styles.r_l} ${lvl.includes(7) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              ...
              fill='#162029'
            />
            <path className={`${styles.delay2} ${styles.t_b} ${lvl.includes(2) ? styles.animate : ''}`} d='M255.49 407.5L255.49 356.5L240.99 342V250' stroke='#162029' />
          </g>
          <g opacity='0.3'>
            <path
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(8) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(8) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay5} ${styles.l_r} ${lvl.includes(8) ? styles.animate : ''}`}
              d='M351 538L296.5 538L282 552.5L190 552.5'
              stroke='#162029'
            />
          </g>
          <path className={`${styles.delay2} ${styles.l_r} ${lvl.includes(3) ? styles.animate : ''}`} d='M450 433.5L540.5 433.5L555.5 421L590 421' stroke='url(#paint1_linear_110_2)' />
          <path
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`}
          ...
          <path
            ...
            fill='#CBC3BA'
          />
          <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(2) ? styles.animate : ''}`} d='M239.5 196.5L239.5 227.5L252 242.5L252 277' stroke='#A6D0DD' />
          <path
            className={`${styles.delay3} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
          ...
          />
          <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay5} ${styles.r_l} ${lvl.includes(7) ? styles.animate : ''}`}
              d='M112 716L287 716'
              stroke='#162029'
            />
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
          ...
          <path
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
            ...
            fill='#A6D0DD'
          />
          <path className={`${styles.delay2} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} d='M112 430L177 430L190 442L250.5 442' stroke='url(#paint2_linear_110_2)' />
          <path
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            <path
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`}
              ...
              fill='black'
            />
            <path className={`${styles.delay5} ${styles.r_l} ${lvl.includes(3) ? styles.animate : ''}`} d='M370.5 442L586 442L602 457.5L643 457.5' stroke='black' />
          </g>
          <path
            className={`${styles.delay4} ${styles.l_r} ${lvl.includes(9) ? styles.animate : ''}`}
            d='M536 532H624.5L655.5 563V584'
            stroke='url(#paint3_linear_110_2)'
          />
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(5) ? styles.animate : ''}`} d='M974 490H1058.5L1089.5 521' stroke='url(#paint4_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} opacity='0.4' d='M-4 361.5H132.5L164.5 393.5V409.5' stroke='url(#paint5_linear_110_2)' />
          <path
            className={`${styles.delay5} ${styles.l_r} ${lvl.includes(9) ? styles.animate : ''}`}
            d='M539.5 519H630L670.5 562V582.5'
            stroke='url(#paint6_linear_110_2)'
          />
          <path className={`${styles.delay4} ${styles.l_r} ${lvl.includes(5) ? styles.animate : ''}`} d='M973.5 478H1064L1104.5 521' stroke='url(#paint7_linear_110_2)' />
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} opacity='0.4' d='M-13 351H135.5L172.5 389V418' stroke='url(#paint8_linear_110_2)' />
          <path className={`${styles.delay4} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} d='M-4 341.5L141.5 341.5L180 383.5V432' stroke='url(#paint9_linear_110_2)' />
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(2) ? styles.animate : ''}`} d='M208 429H276.5L312 464V472' stroke='url(#paint10_linear_110_2)' />
          <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='312' cy='475' r='2.25' stroke='#A7D1DE' strokeWidth='1.5' />
          <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='206' cy='429' r='2.25' stroke='#9E9C97' strokeWidth='1.5' />
          <g opacity='0.4'>
            <path
              className={`${styles.delay5} ${styles.l_r} ${lvl.includes(9) ? styles.animate : ''}`}
            ...
            />
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(9) ? styles.animate : ''}`}
              cx='641'
              cy='574'
              r='2.25'
              stroke='#162029'
            ...
            />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(9) ? styles.animate : ''}`}
              cx='473'
              cy='545'
              r='2.25'
              stroke='#162029'
          ...
          <path
            className={`${styles.delay3} ${styles.t_b} ${lvl.includes(7) ? styles.animate : ''}`}
            d='M17.5 604L17.5 684.5L37.5 705L44 705'
            stroke='url(#paint11_linear_110_2)'
          />
          <circle
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
            cx='3'
            cy='3'
            r='2.25'
          ...
          <circle
            ...
            strokeWidth='1.5'
          />
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(10) ? styles.animate : ''}`} d='M710 995.5L790.5 995.5L811 975.5L811 969' stroke='#A6D0DD' />
          <circle
            className={`${styles.delay2} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`}
            cx='3'
            cy='3'
            r='2.25'
          ...
          />
          <circle
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`}
            cx='3'
            cy='3'
            r='2.25'
            ...
            strokeWidth='1.5'
          />
          <path className={`${styles.delay2} ${styles.l_r} ${lvl.includes(4) ? styles.animate : ''}`} d='M743 107.5L823.5 107.5L844 127.5L844 134' stroke='#A6D0DD' />
          <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='844' cy='136' r='2.25' stroke='#A6D0DD' strokeWidth='1.5' />
          <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='741' cy='108' r='2.25' stroke='#A6D0DD' strokeWidth='1.5' />
          <path
            className={`${styles.delay5} ${styles.l_r} ${lvl.includes(8) ? styles.animate : ''}`}
          ...
          />
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='329' cy='423' r='4' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='341' cy='423' r='4' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='353' cy='423' r='4' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='365' cy='423' r='4' fill='#162029' />
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='377' cy='423' r='4' fill='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='694' cy='265' r='4' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='706' cy='265' r='4' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='718' cy='265' r='4' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='730' cy='265' r='4' fill='#162029' />
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='742' cy='265' r='4' fill='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='694' cy='278' r='4' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='706' cy='278' r='4' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='718' cy='278' r='4' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='730' cy='278' r='4' fill='#FF6969' />
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='742' cy='278' r='4' fill='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(9) ? styles.animate : ''}`}
              cx='568'
              cy='780'
              r='4'
            ...
            />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(9) ? styles.animate : ''}`}
              cx='568'
              cy='768'
              r='4'
            ...
            />
            <circle
              className={`${styles.delay5} ${styles.opacity} ${lvl.includes(9) ? styles.animate : ''}`}
              cx='568'
              cy='732'
              r='4'
          ...
          <g opacity='0.4'>
            <circle
              className={`${styles.delay5} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
              cx='41'
              cy='930'
              r='4'
            ...
            />
            <circle
              className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(7) ? styles.animate : ''}`}
              cx='41'
              cy='882'
              r='4'
          ...
          />
          <circle
            className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(7) ? styles.animate : ''}`}
            opacity='0.3'
            cx='54'
            cy='918'
            r='4'
          ...
          />
          <circle
            className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(7) ? styles.animate : ''}`}
            cx='54'
            cy='906'
            r='4'
          ...
          />
          <circle
            className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(7) ? styles.animate : ''}`}
            opacity='0.3'
            cx='54'
            cy='894'
            r='4'
          ...
          />
          <circle
            className={`${styles.delay5} ${styles.opacityH} ${lvl.includes(7) ? styles.animate : ''}`}
            opacity='0.3'
            cx='54'
            cy='882'
            r='4'
            ...
            fill='#162029'
          />
          <circle className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`}opacity='0.3' cx='143' cy='439' r='3' fill='#162029' />
          <circle className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`}opacity='0.4' cx='153' cy='439' r='3' fill='#162029' />
          <circle className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`}opacity='0.3' cx='163' cy='439' r='3' fill='#162029' />
          <circle className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`} opacity='0.3' cx='173' cy='439' r='3' fill='#162029' />
          <circle
            className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`}
            opacity='0.3'
            cx='428'
            cy='691'
            r='3'
          ...
          />
          <circle
            className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`}
            opacity='0.4'
            cx='438'
            cy='691'
            r='3'
          ...
          />
          <circle
            className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`}
            opacity='0.3'
            cx='448'
            cy='691'
            r='3'
          ...
          <circle
            ...
            fill='#A6D0DD'
          />
          <circle className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(1) ? styles.animate : ''}`} opacity='0.3' cx='220' cy='284' r='3' transform='rotate(-90 220 284)' fill='#162029' />
          <circle className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(1) ? styles.animate : ''}`} opacity='0.4' cx='220' cy='274' r='3' transform='rotate(-90 220 274)' fill='#162029' />
          <circle className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(1) ? styles.animate : ''}`} opacity='0.3' cx='220' cy='264' r='3' transform='rotate(-90 220 264)' fill='#162029' />
          <circle className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(1) ? styles.animate : ''}`} cx='220' cy='254' r='3' transform='rotate(-90 220 254)' fill='#A6D0DD' />
          <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} opacity='0.3' cx='936' cy='457' r='3' transform='rotate(90 936 457)' fill='#162029' />
          <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} opacity='0.4' cx='936' cy='467' r='3' transform='rotate(90 936 467)' fill='#162029' />
          <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} opacity='0.3' cx='936' cy='477' r='3' transform='rotate(90 936 477)' fill='#162029' />
          <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='936' cy='487' r='3' transform='rotate(90 936 487)' fill='#A6D0DD' />
          <circle
            className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(7) ? styles.animate : ''}`}
            opacity='0.3'
            cx='83'
          ...
          />
          <circle
            className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`}
            opacity='0.3'
            cx='309'
            cy='557'
            r='3'
          ...
          <circle
            ...
            fill='#162029'
          />
          <circle className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(11) ? styles.animate : ''}`} opacity='0.3' cx='1086' cy='784' r='3' transform='rotate(-90 1086 784)' fill='#162029' />
          <circle className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(11) ? styles.animate : ''}`} opacity='0.4' cx='1086' cy='774' r='3' transform='rotate(-90 1086 774)' fill='#162029' />
          <circle className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(11) ? styles.animate : ''}`} opacity='0.3' cx='1086' cy='764' r='3' transform='rotate(-90 1086 764)' fill='#162029' />
          <circle className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(11) ? styles.animate : ''}`} opacity='0.3' cx='1086' cy='754' r='3' transform='rotate(-90 1086 754)' fill='#162029' />
          <g opacity='0.4'>
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='372' cy='368' r='2.25' stroke='#FF6969' strokeWidth='1.5' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='372' cy='404' r='2.25' stroke='#FF6969' strokeWidth='1.5' />
            <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(2) ? styles.animate : ''}`} d='M372 370.5C372 396.1 372 402.5 372 402.5' stroke='#FF6969' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay3} ${styles.b_t} ${lvl.includes(7) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            ...
            />
            <path
              className={`${styles.delay5} ${styles.t_b} ${lvl.includes(7) ? styles.animate : ''}`}
              d='M160 547C160 556.6 160 559 160 559'
              stroke='#162029'
            />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='98' cy='429' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='98' cy='465' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`} d='M98 431.5C98 457.1 98 463.5 98 463.5' stroke='black' />
          </g>
          <circle
            className={`${styles.delay3} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
            cx='55'
          ...
          />
          <path
            className={`${styles.delay5} ${styles.b_t} ${lvl.includes(7) ? styles.animate : ''}`}
            d='M55 727.5C55 753.1 55 759.5 55 759.5'
            stroke='#A6D0DD'
          />
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='110' cy='442' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='110' cy='465' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay2} ${styles.b_t} ${lvl.includes(1) ? styles.animate : ''}`} d='M110 445C110 459.4 110 463 110 463' stroke='black' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='85' cy='429' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='85' cy='445' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay5} ${styles.b_t} ${lvl.includes(1) ? styles.animate : ''}`} d='M85 432C85 440.8 85 443 85 443' stroke='black' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='885' cy='684' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='885' cy='720' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay5} ${styles.b_t} ${lvl.includes(10) ? styles.animate : ''}`} d='M885 686.5C885 712.1 885 718.5 885 718.5' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='876' cy='675' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='876' cy='691' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(10) ? styles.animate : ''}`} d='M876 678C876 686.8 876 689 876 689' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(9) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay5} ${styles.b_t} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            ...
            />
            <path
              className={`${styles.delay3} ${styles.b_t} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            ...
            />
            <path
              className={`${styles.delay4} ${styles.t_b} ${lvl.includes(9) ? styles.animate : ''}`}
              d='M637 931C637 939.8 637 942 637 942'
              stroke='#162029'
            />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='360' cy='376' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='360' cy='412' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(2) ? styles.animate : ''}`} d='M360 378.5C360 404.1 360 410.5 360 410.5' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='49' cy='312' r='2.25' transform='rotate(180 49 312)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='49' cy='295' r='2.25' transform='rotate(180 49 295)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`} d='M49 309C49 299.4 49 297 49 297' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='49' cy='287' r='2.25' transform='rotate(180 49 287)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='49' cy='251' r='2.25' transform='rotate(180 49 251)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay5} ${styles.b_t} ${lvl.includes(1) ? styles.animate : ''}`} d='M49 284.5C49 258.9 49 252.5 49 252.5' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='31' cy='306' r='2.25' transform='rotate(180 31 306)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='31' cy='270' r='2.25' transform='rotate(180 31 270)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`} d='M31 303.5C31 277.9 31 271.5 31 271.5' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='40' cy='316' r='2.25' transform='rotate(180 40 316)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='40' cy='254' r='2.25' transform='rotate(180 40 254)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(1) ? styles.animate : ''}`} d='M40 314C40 267.6 40 256 40 256' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='827' cy='363' r='2.25' transform='rotate(180 827 363)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='827' cy='346' r='2.25' transform='rotate(180 827 346)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay1} ${styles.t_b} ${lvl.includes(4) ? styles.animate : ''}`} d='M827 360C827 350.4 827 348 827 348' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='827' cy='338' r='2.25' transform='rotate(180 827 338)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='827' cy='302' r='2.25' transform='rotate(180 827 302)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay1} ${styles.b_t} ${lvl.includes(4) ? styles.animate : ''}`} d='M827 335.5C827 309.9 827 303.5 827 303.5' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='809' cy='357' r='2.25' transform='rotate(180 809 357)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='809' cy='321' r='2.25' transform='rotate(180 809 321)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(4) ? styles.animate : ''}`} d='M809 354.5C809 328.9 809 322.5 809 322.5' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='818' cy='367' r='2.25' transform='rotate(180 818 367)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='818' cy='305' r='2.25' transform='rotate(180 818 305)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay2} ${styles.b_t} ${lvl.includes(4) ? styles.animate : ''}`} d='M818 365C818 318.6 818 307 818 307' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(9) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay3} ${styles.t_b} ${lvl.includes(9) ? styles.animate : ''}`}
              d='M668 770C668 779.6 668 782 668 782'
              stroke='#162029'
            />
          </g>
          <path
            className={`${styles.delay5} ${styles.t_b} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          />
          <path
            className={`${styles.delay4} ${styles.b_t} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          />
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='348' cy='368' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='348' cy='412' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(2) ? styles.animate : ''}`} d='M348 371C348 403 348 411 348 411' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(8) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
              cx='61.2426'
              cy='106.243'
              r='2.25'
            ...
            />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
              cx='93.2426'
              cy='138.243'
              r='2.25'
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay4} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} d='M63.364 108.364C85.9914 130.991 91.6482 136.648 91.6482 136.648' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`}
              cx='70.2426'
              cy='145.243'
              r='2.25'
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay2} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} d='M72.364 147.364C89.164 164.164 93.364 168.364 93.364 168.364' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} d='M44.364 105.364C79.564 140.564 88.364 149.364 88.364 149.364' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(7) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1164' cy='426' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1164' cy='462' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(5) ? styles.animate : ''}`} d='M1164 428.5C1164 454.1 1164 460.5 1164 460.5' stroke='#162029' />
          </g>
          <g opacity='0.34'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1152' cy='434' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1152' cy='470' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(5) ? styles.animate : ''}`} d='M1152 436.5C1152 462.1 1152 468.5 1152 468.5' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1140' cy='426' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1140' cy='470' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(5) ? styles.animate : ''}`} d='M1140 429C1140 461 1140 469 1140 469' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='251' cy='292' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='251' cy='336' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(2) ? styles.animate : ''}`} d='M251 295C251 327 251 335 251 335' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <path
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(8) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(8) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay3} ${styles.t_b} ${lvl.includes(8) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            ...
            />
            <path
              className={`${styles.delay5} ${styles.b_t} ${lvl.includes(8) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay1} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} d='M53 426L53 451' stroke='url(#paint15_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} d='M68 426L68 445' stroke='url(#paint16_linear_110_2)' />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(3) ? styles.animate : ''}`} opacity='0.4' d='M48 426L48 453' stroke='#162029' />
          <path className={`${styles.delay3} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} opacity='0.4' d='M670 320L670 347' stroke='#162029' />
          <path className={`${styles.delay2} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} opacity='0.4' d='M685 335L685 362' stroke='#162029' />
          <path className={`${styles.delay1} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} opacity='0.4' d='M679 320L679 368' stroke='#162029' />
          <path className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} d='M170 155L170 212' stroke='url(#paint17_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(1) ? styles.animate : ''}`} opacity='0.4' d='M184 200L184 227' stroke='#162029' />
          <path className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} d='M177 185L177 233' stroke='url(#paint18_linear_110_2)' />
          <path className={`${styles.delay5} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.4' d='M1270 173L1270 230' stroke='#162029' />
          <path className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.4' d='M1285 218L1285 245' stroke='#162029' />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.4' d='M1279 203L1279 251' stroke='#162029' />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(2) ? styles.animate : ''}`} opacity='0.4' d='M329 293H435' stroke='url(#paint19_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} d='M353 285L402 285' stroke='url(#paint20_linear_110_2)' />
          <path className={`${styles.delay1} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} d='M340 301H446' stroke='url(#paint21_linear_110_2)' />
          <path className={`${styles.delay3} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} opacity='0.4' d='M862 418H968' stroke='#162029' />
          <path className={`${styles.delay2} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} opacity='0.4' d='M886 410L935 410' stroke='#162029' />
          <path className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} d='M873 426H979' stroke='url(#paint22_linear_110_2)' />
          <path
            className={`${styles.delay5} ${styles.l_r} ${lvl.includes(7) ? styles.animate : ''}`}
            opacity='0.4'
            d='M292 908L149 908'
            stroke='url(#paint23_linear_110_2)'
          />
          <path
            className={`${styles.delay4} ${styles.r_l} ${lvl.includes(7) ? styles.animate : ''}`}
            opacity='0.4'
            d='M231 916L182 916'
            stroke='#162029'
          />
          <path
            className={`${styles.delay3} ${styles.l_r} ${lvl.includes(7) ? styles.animate : ''}`}
            d='M244 900L138 900'
            stroke='#FF6969'
          />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(3) ? styles.animate : ''}`} opacity='0.4' d='M643 102L500 102' stroke='url(#paint24_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(3) ? styles.animate : ''}`} opacity='0.4' d='M582 110L533 110' stroke='#162029' />
          <path className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(3) ? styles.animate : ''}`} d='M595 94L489 94' stroke='#FF6969' />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`} opacity='0.4' d='M1319 581L1176 581' stroke='url(#paint25_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`} opacity='0.4' d='M1258 589L1209 589' stroke='#162029' />
          <path className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`} d='M1271 573L1165 573' stroke='#FF6969' />
          <path className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`} opacity='0.4' d='M63 426L63 450' stroke='#162029' />
          <path className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`} opacity='0.4' d='M58 426L58 448' stroke='#162029' />
          <path
            className={`${styles.delay3} ${styles.t_b} ${lvl.includes(9) ? styles.animate : ''}`}
            d='M625 750L625 806'
          ...
          />
          <path
            className={`${styles.delay2} ${styles.b_t} ${lvl.includes(9) ? styles.animate : ''}`}
            opacity='0.4'
            d='M621 750L621 797'
            stroke='url(#paint27_linear_110_2)'
          />
          <path
            className={`${styles.delay1} ${styles.t_b} ${lvl.includes(9) ? styles.animate : ''}`}
            opacity='0.4'
            d='M629 750L629 808'
            stroke='url(#paint28_linear_110_2)'
          />
          <path
            className={`${styles.delay1} ${styles.t_b} ${lvl.includes(7) ? styles.animate : ''}`}
            opacity='0.4'
            d='M72 682L72 716'
            stroke='url(#paint29_linear_110_2)'
          />
          <path
            className={`${styles.delay2} ${styles.t_b} ${lvl.includes(7) ? styles.animate : ''}`}
            opacity='0.4'
            d='M68 682L68 716'
          ...
          />
          <path
            className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(9) ? styles.animate : ''}`}
            opacity='0.4'
            d='M488 521L488 536'
            stroke='url(#paint32_linear_110_2)'
          />
          <path
            className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(9) ? styles.animate : ''}`}
            opacity='0.4'
            d='M484 521L484 541'
            stroke='url(#paint33_linear_110_2)'
          />
          <path
            className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(9) ? styles.animate : ''}`}
            opacity='0.4'
            d='M492 521L492 532'
            stroke='url(#paint34_linear_110_2)'
          />
          <path className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(1) ? styles.animate : ''}`} opacity='0.4' d='M73 426L73 449' stroke='#162029' />
          <g opacity='0.4'>
            <path className={`${styles.delay2} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`} d='M25.5 399.5L12.5 421.5V519.5L37 544V609.5' stroke='#162029' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='27' cy='397' r='3' transform='rotate(180 27 397)' stroke='#162029' strokeWidth='2' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`} cx='37' cy='613' r='3' transform='rotate(180 37 613)' stroke='#162029' strokeWidth='2' />
          </g>
          <path
            className={`${styles.delay5} ${styles.r_l} ${lvl.includes(7) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay3} ${styles.l_r} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay5} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} d='M-1 333H146.5L189 377.5V465.5' stroke='#A6D0DD' />
          <path
            className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(8) ? styles.animate : ''}`}
            opacity='0.4'
          ...
          <circle
            ...
            strokeWidth='1.5'
          />
          <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(3) ? styles.animate : ''}`} d='M544.5 364L544.5 283.5L564.5 263L571 263' stroke='url(#paint40_linear_110_2)' />
          <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} cx='573' cy='263' r='2.25' transform='rotate(-90 573 263)' stroke='#ACCAD6' strokeWidth='1.5' />
          <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} cx='545' cy='366' r='2.25' transform='rotate(-90 545 366)' stroke='#FD6C6D' strokeWidth='1.5' />
          <g opacity='0.4'>
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} cx='516' cy='309' r='2.25' transform='rotate(-90 516 309)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`} cx='533' cy='309' r='2.25' transform='rotate(-90 533 309)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay5} ${styles.r_l} ${lvl.includes(3) ? styles.animate : ''}`} d='M519 309C528.6 309 531 309 531 309' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(3) ? styles.animate : ''}`} d='M535.5 384.5L535.5 335L522 324L503 324' stroke='#162029' />
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay5} ${styles.b_t} ${lvl.includes(10) ? styles.animate : ''}`} d='M795.5 804L795.5 723.5L815.5 703L822 703' stroke='url(#paint41_linear_110_2)' />
          <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='824' cy='703' r='2.25' transform='rotate(-90 824 703)' stroke='#ACCAD6' strokeWidth='1.5' />
          <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='796' cy='806' r='2.25' transform='rotate(-90 796 806)' stroke='#FD6C6D' strokeWidth='1.5' />
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='767' cy='749' r='2.25' transform='rotate(-90 767 749)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='784' cy='749' r='2.25' transform='rotate(-90 784 749)' stroke='#162029' strokeWidth='1.5' />
            <path
              className={`${styles.delay3} ${styles.l_r} ${lvl.includes(10) ? styles.animate : ''}`}
              d='M770 749C779.6 749 782 749 782 749'
              stroke='#162029'
            />
          </g>
          <g opacity='0.4'>
            <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(10) ? styles.animate : ''}`} d='M786.5 824.5L786.5 775L773 764L754 764' stroke='#162029' />
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay5} ${styles.r_l} ${lvl.includes(8) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            ...
            />
            <path
              className={`${styles.delay5} ${styles.r_l} ${lvl.includes(10) ? styles.animate : ''}`}
              d='M762 580C790.8 580 798 580 798 580'
              stroke='#162029'
            />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='457' cy='394' r='2.25' transform='rotate(180 457 394)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='457' cy='377' r='2.25' transform='rotate(180 457 377)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(2) ? styles.animate : ''}`} d='M457 391C457 381.4 457 379 457 379' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay2} ${styles.t_b} ${lvl.includes(4) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(3) ? styles.animate : ''}`} d='M566 190C585.2 190 590 190 590 190' stroke='url(#paint43_linear_110_2)' />
          <circle
            className={`${styles.delay2} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`}
            cx='3'
            cy='3'
          ...
          />
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(2) ? styles.animate : ''}`} d='M396 240C442.4 240 454 240 454 240' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay3} ${styles.r_l} ${lvl.includes(3) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.t_b} ${lvl.includes(2) ? styles.animate : ''}`} d='M467 392C467 345.6 467 334 467 334' stroke='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(1 0 0 -1 464 397)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(1 0 0 -1 464 335)' stroke='#162029' strokeWidth='1.5' />
          </g>
          <g opacity='0.4'>
            <path
              className={`${styles.delay3} ${styles.r_l} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay2} ${styles.b_t} ${lvl.includes(2) ? styles.animate : ''}`} d='M457 363C457 316.6 457 305 457 305' stroke='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(1 0 0 -1 454 368)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(1 0 0 -1 454 306)' stroke='#162029' strokeWidth='1.5' />
          </g>
          <g opacity='0.4'>
            <path
              className={`${styles.delay5} ${styles.b_t} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay4} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`} d='M160.657 310.657C106.257 256.257 92.6569 242.657 92.6569 242.657' stroke='#162029' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay4} ${styles.r_l} ${lvl.includes(2) ? styles.animate : ''}`} d='M445 135.5H379L317 197.5' stroke='black' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(3) ? styles.animate : ''}`} d='M586.558 270.303L633.227 316.972L633.227 404.653' stroke='black' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(3) ? styles.animate : ''}`}
              cx='633.581'
              cy='407.128'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(2) ? styles.animate : ''}`} d='M451 143.5H385L323 205.5' stroke='black' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(2) ? styles.animate : ''}`} d='M270.749 133.657C294.749 109.657 300.749 103.657 300.749 103.657' stroke='#162029' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.r_l} ${lvl.includes(2) ? styles.animate : ''}`} d='M267.749 122.657C284.549 105.857 288.749 101.657 288.749 101.657' stroke='#162029' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(2) ? styles.animate : ''}`} d='M396.13 153C419.889 153 425.828 153 425.828 153' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay2} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`} d='M170.828 321.749C181.228 332.149 183.828 334.749 183.828 334.749' stroke='#162029' />
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`} d='M96.8284 263.689C125.628 292.489 132.828 299.689 132.828 299.689' stroke='#162029' />
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
              cx='3'
              cy='3'
              r='2.25'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay5} ${styles.r_l} ${lvl.includes(2) ? styles.animate : ''}`} d='M245.657 131.669C278.467 98.8592 286.669 90.6568 286.669 90.6568' stroke='#162029' />
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              cx='3'
              cy='3'
              r='2.25'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(2) ? styles.animate : ''}`} d='M342.657 202.669C375.467 169.859 383.669 161.657 383.669 161.657' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(2) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.3'>
            <path
              className={`${styles.delay3} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            <path
              className={`${styles.delay2} ${styles.t_b} ${lvl.includes(8) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path
              className={`${styles.delay2} ${styles.b_t} ${lvl.includes(2) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path
              className={`${styles.delay5} ${styles.r_l} ${lvl.includes(2) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path
              className={`${styles.delay3} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay1} ${styles.t_b} ${lvl.includes(1) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay5} ${styles.l_r} ${lvl.includes(1) ? styles.animate : ''}`} d='M79.0001 103.5L149.5 174V224.5L218 293.5' stroke='black' />
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(1) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(4) ? styles.animate : ''}`} d='M874.361 265.01L874.361 364.713L838.652 400.421L838.298 497.649' stroke='black' />
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
                className={`${styles.delay5} ${styles.t_b} ${lvl.includes(3) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            <path
              className={`${styles.delay2} ${styles.r_l} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            <path
              className={`${styles.delay2} ${styles.l_r} ${lvl.includes(4) ? styles.animate : ''}`}
            ...
            />
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay2} ${styles.r_l} ${lvl.includes(7) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay3} ${styles.l_r} ${lvl.includes(3) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            <path
              className={`${styles.delay3} ${styles.r_l} ${lvl.includes(10) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            <path
              className={`${styles.delay3} ${styles.b_t} ${lvl.includes(4) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay5} ${styles.b_t} ${lvl.includes(2) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(4) ? styles.animate : ''}`} d='M687 132.5H804L825 152.5V177.5' stroke='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(1 0 0 -1 822 183)' stroke='#162029' strokeWidth='1.5' />
          </g>
          <g opacity='0.3'>
            <path className={`${styles.delay5} ${styles.l_r} ${lvl.includes(11) ? styles.animate : ''}`} d='M1142.5 969L1054 969L1039 984' stroke='black' />
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(11) ? styles.animate : ''}`} d='M1142 970H1053L1038 985' stroke='white' />
          <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
              ...
              fill='#162029'
            />
            <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(12) ? styles.animate : ''}`} d='M1379.51 922.5V871.5L1394.01 857V765' stroke='#162029' />
          </g>
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(11) ? styles.animate : ''}`} d='M1185 948.5L1094.5 948.5L1079.5 936L1045 936' stroke='url(#paint44_linear_110_2)' />
          <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
          ...
          />
          <path
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
            ...
            fill='#CBC3BA'
          />
          <path className={`${styles.delay5} ${styles.b_t} ${lvl.includes(11) ? styles.animate : ''}`} d='M1138.5 716L1138.5 625.5L1151 610.5L1151 576' stroke='url(#paint45_linear_110_2)' />
          <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
          ...
          />
          <path
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
            ...
            fill='#CBC3BA'
          />
          <path className={`${styles.delay3} ${styles.b_t} ${lvl.includes(12) ? styles.animate : ''}`} d='M1395.5 711.5L1395.5 742.5L1383 757.5L1383 792' stroke='#A6D0DD' />
          <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
          ...
          <path
            ...
            fill='#A6D0DD'
          />
          <path className={`${styles.delay3} ${styles.b_t} ${lvl.includes(11) ? styles.animate : ''}`} d='M1141.5 576.5L1141.5 607.5L1129 622.5L1129 657' stroke='#A6D0DD' />
          <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
          ...
          <path
            ...
            fill='#A6D0DD'
          />
          <path className={`${styles.delay5} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1523 945L1458 945L1445 957L1384.5 957' stroke='url(#paint46_linear_110_2)' />
          <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            ...
            <path
              ...
              fill='black'
            />
            <path className={`${styles.delay4} ${styles.r_l} ${lvl.includes(11) ? styles.animate : ''}`} d='M1264.5 957L1049 957L1033 972.5L992 972.5' stroke='black' />
          </g>
          <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(12) ? styles.animate : ''}`} d='M1427 944H1358.5L1323 979V987' stroke='url(#paint47_linear_110_2)' />
          <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1326 987)' stroke='#A7D1DE' strokeWidth='1.5' />
          <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1432 941)' stroke='#9E9C97' strokeWidth='1.5' />
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1310 934)' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1298 934)' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1286 934)' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1274 934)' fill='#162029' />
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 1262 934)' fill='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 945 776)' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 933 776)' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 921 776)' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 909 776)' fill='#162029' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 897 776)' fill='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 945 789)' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 933 789)' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 921 789)' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 909 789)' fill='#FF6969' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`} cx='4' cy='4' r='4' transform='matrix(-1 0 0 1 897 789)' fill='#162029' />
          </g>
          <circle
              className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`}
            opacity='0.3'
            cx='3'
            cy='3'
            r='3'
          ...
          />
          <circle
            className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`}
            opacity='0.4'
            cx='3'
            cy='3'
            r='3'
          ...
          />
          <circle
            className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`}className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
            opacity='0.3'
            cx='3'
            cy='3'
            r='3'
            ...
            fill='#162029'
          />
          <circle className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='3' transform='matrix(4.37114e-08 -1 -1 -4.37114e-08 1418 772)' fill='#A6D0DD' />
          <g opacity='0.4'>
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1266 880)' stroke='#FF6969' strokeWidth='1.5' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1266 916)' stroke='#FF6969' strokeWidth='1.5' />
            <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(12) ? styles.animate : ''}`} d='M1263 885.5C1263 911.1 1263 917.5 1263 917.5' stroke='#FF6969' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1278 888)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1278 924)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(12) ? styles.animate : ''}`} d='M1275 893.5C1275 919.1 1275 925.5 1275 925.5' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1290 880)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1290 924)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(12) ? styles.animate : ''}`} d='M1287 886C1287 918 1287 926 1287 926' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1387 804)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1387 848)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.t_b} ${lvl.includes(12) ? styles.animate : ''}`} d='M1384 810C1384 842 1384 850 1384 850' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1132 671)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='3' cy='3' r='2.25' transform='matrix(-1 0 0 1 1132 715)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.t_b} ${lvl.includes(11) ? styles.animate : ''}`} d='M1129 677C1129 709 1129 717 1129 717' stroke='#162029' />
          </g>
          <path className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(11) ? styles.animate : ''}`} opacity='0.4' d='M965 835L965 862' stroke='#162029' />
          <path className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(11) ? styles.animate : ''}`} opacity='0.4' d='M950 850L950 877' stroke='#162029' />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(11) ? styles.animate : ''}`} opacity='0.4' d='M956 835L956 883' stroke='#162029' />
          <path
            className={`${styles.delay1} ${styles.b_t} ${lvl.includes(8) ? styles.animate : ''}`}
            opacity='0.4'
            d='M365 688L365 745'
            stroke='#162029'
          />
          <path
            className={`${styles.delay3} ${styles.b_t} ${lvl.includes(8) ? styles.animate : ''}`}
            opacity='0.4'
            d='M350 733L350 760'
            stroke='#162029'
          />
          <path
            ...
            stroke='#162029'
          />
          <path className={`${styles.delay1} ${styles.r_l} ${lvl.includes(12) ? styles.animate : ''}`} opacity='0.4' d='M1308 845H1202' stroke='url(#paint48_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1284 837L1235 837' stroke='url(#paint49_linear_110_2)' />
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1297 853H1191' stroke='url(#paint50_linear_110_2)' />
          <path
            className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(9) ? styles.animate : ''}`}
            opacity='0.4'
            d='M773 933H667'
          ...
          />
          <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(11) ? styles.animate : ''}`} d='M1090.5 879L1090.5 798.5L1070.5 778L1064 778' stroke='url(#paint52_linear_110_2)' />
          <circle
            className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
            cx='3'
            cy='3'
          ...
          <g opacity='0.4'>
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(11) ? styles.animate : ''}`} d='M1116 824C1106.4 824 1104 824 1104 824' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.r_l} ${lvl.includes(11) ? styles.animate : ''}`} d='M1099.5 899.5L1099.5 850L1113 839L1132 839' stroke='#162029' />
            <path
                className={`${styles.delay3} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(11) ? styles.animate : ''}`} d='M1178 906C1178 896.4 1178 894 1178 894' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <path
              className={`${styles.delay3} ${styles.t_b} ${lvl.includes(10) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(11) ? styles.animate : ''}`} d='M1069 705C1049.8 705 1045 705 1045 705' stroke='url(#paint53_linear_110_2)' />
          <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='1071' cy='705' r='2.25' transform='rotate(90 1071 705)' stroke='#A5CEDB' strokeWidth='1.5' />
          <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='1043' cy='705' r='2.25' transform='rotate(90 1043 705)' stroke='#9C9B97' strokeWidth='1.5' />
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1239 755C1192.6 755 1181 755 1181 755' stroke='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1241' cy='755' r='2.25' transform='rotate(90 1241 755)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1179' cy='755' r='2.25' transform='rotate(90 1179 755)' stroke='#162029' strokeWidth='1.5' />
          </g>
          <g opacity='0.4'>
            <path
                className={`${styles.delay5} ${styles.l_r} ${lvl.includes(11) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(11) ? styles.animate : ''}`} d='M1168 907C1168 860.6 1168 849 1168 849' stroke='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='1168' cy='909' r='2.25' transform='rotate(180 1168 909)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='1168' cy='847' r='2.25' transform='rotate(180 1168 847)' stroke='#162029' strokeWidth='1.5' />
          </g>
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(11) ? styles.animate : ''}`} d='M1178 878C1178 831.6 1178 820 1178 820' stroke='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='1178' cy='880' r='2.25' transform='rotate(180 1178 880)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='1178' cy='818' r='2.25' transform='rotate(180 1178 818)' stroke='#162029' strokeWidth='1.5' />
          </g>
          <g opacity='0.3'>
            <path className={`${styles.delay4} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1190 650.5H1256L1318 712.5' stroke='black' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1320' cy='714' r='2.25' transform='rotate(90 1320 714)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1188' cy='651' r='2.25' transform='rotate(90 1188 651)' stroke='#162029' strokeWidth='1.5' />
          </g>
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(11) ? styles.animate : ''}`} d='M1048.44 785.303L1001.77 831.972L1001.77 919.653' stroke='black' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1184 658.5H1250L1312 720.5' stroke='black' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1314' cy='722' r='2.25' transform='rotate(90 1314 722)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1182' cy='659' r='2.25' transform='rotate(90 1182 659)' stroke='#162029' strokeWidth='1.5' />
          </g>
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1364.25 648.657C1340.25 624.657 1334.25 618.657 1334.25 618.657' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
              cx='1365.68'
              cy='650.242'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1367.25 637.657C1350.45 620.857 1346.25 616.657 1346.25 616.657' stroke='#162029' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
              cx='1368.68'
              cy='639.242'
              r='2.25'
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay5} ${styles.t_b} ${lvl.includes(10) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay2} ${styles.r_l} ${lvl.includes(12) ? styles.animate : ''}`} d='M1238.87 668C1215.11 668 1209.17 668 1209.17 668' stroke='#162029' />
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
              cx='1241'
              cy='668.113'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay5} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1389.34 646.669C1356.53 613.859 1348.33 605.657 1348.33 605.657' stroke='#162029' />
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
              cx='1390.76'
              cy='648.083'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(12) ? styles.animate : ''}`} d='M1292.34 717.669C1259.53 684.859 1251.33 676.657 1251.33 676.657' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
              cx='1293.76'
              cy='719.083'
          ...
          <g opacity='0.3'>
            <path
                className={`${styles.delay4} ${styles.b_t} ${lvl.includes(12) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path
                className={`${styles.delay5} ${styles.l_r} ${lvl.includes(10) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path
              className={`${styles.delay5} ${styles.b_t} ${lvl.includes(12) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path
                className={`${styles.delay5} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay3} ${styles.b_t} ${lvl.includes(12) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay5} ${styles.l_r} ${lvl.includes(12) ? styles.animate : ''}`} d='M1556 618.5L1485.5 689V739.5L1417 808.5' stroke='black' />
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
                className={`${styles.delay5} ${styles.b_t} ${lvl.includes(11) ? styles.animate : ''}`}
          ...
          <g opacity='0.15'>
            <path
              className={`${styles.delay1} ${styles.l_r} ${lvl.includes(9) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            <path
              className={`${styles.delay3} ${styles.b_t} ${lvl.includes(10) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(5) ? styles.animate : ''}`} d='M1185.5 124.699L1097 124.699L1082 109.699' stroke='black' />
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay2} ${styles.r_l} ${lvl.includes(5) ? styles.animate : ''}`} d='M1185 123.699H1096L1081 108.699' stroke='white' />
          <path
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              ...
              fill='#162029'
            />
            <path className={`${styles.delay3} ${styles.b_t} ${lvl.includes(6) ? styles.animate : ''}`} d='M1422.51 171.199V222.199L1437.01 236.699V328.699' stroke='#162029' />
          </g>
          <g opacity='0.3'>
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              ...
              fill='#162029'
            />
            <path className={`${styles.delay5} ${styles.l_r} ${lvl.includes(6) ? styles.animate : ''}`} d='M1327 40.6992L1381.5 40.6992L1396 26.1992L1488 26.1992' stroke='#162029' />
          </g>
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(6) ? styles.animate : ''}`} d='M1228 145.199L1137.5 145.199L1122.5 157.699L1088 157.699' stroke='url(#paint54_linear_110_2)' />
          <path
            className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
          ...
          />
          <path
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
            ...
            fill='#CBC3BA'
          />
          <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`} d='M1438.5 382.199L1438.5 351.199L1426 336.199L1426 301.699' stroke='#A6D0DD' />
          <path
            className={`${styles.delay4} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
          ...
          />
          <path
            className={`${styles.delay3} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
            ...
            fill='#A6D0DD'
          />
          <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(6) ? styles.animate : ''}`} d='M1566 148.699L1501 148.699L1488 136.699L1427.5 136.699' stroke='url(#paint55_linear_110_2)' />
          <path
            className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
          ...
          <g opacity='0.2'>
            ...
            <path
              ...
              fill='black'
            />
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(6) ? styles.animate : ''}`} d='M1307.5 136.699L1092 136.699L1076 121.199L1035 121.199' stroke='black' />
          </g>
          <path className={`${styles.delay1} ${styles.r_l} ${lvl.includes(5) ? styles.animate : ''}`} d='M1142 46.6992H1053.5L1022.5 15.6992V-5.30078' stroke='url(#paint56_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.r_l} ${lvl.includes(5) ? styles.animate : ''}`} d='M1138.5 59.6992L1048 59.6992L1007.5 16.6992V-3.80078' stroke='url(#paint57_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.l_r} ${lvl.includes(6) ? styles.animate : ''}`} d='M1470 149.699H1401.5L1366 114.699V106.699' stroke='url(#paint58_linear_110_2)' />
          <circle
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
            cx='1366'
            cy='103.699'
          ...
          />
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(5) ? styles.animate : ''}`} d='M1202.5 33.1992L1057.5 33.1992L1037 13.1992V6.69922' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`}
              cx='1037'
              cy='4.69922'
          ...
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} cx='1349' cy='155.699' r='4' transform='rotate(180 1349 155.699)' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} cx='1337' cy='155.699' r='4' transform='rotate(180 1337 155.699)' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} cx='1325' cy='155.699' r='4' transform='rotate(180 1325 155.699)' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} cx='1313' cy='155.699' r='4' transform='rotate(180 1313 155.699)' fill='#162029' />
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} cx='1301' cy='155.699' r='4' transform='rotate(180 1301 155.699)' fill='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1296' cy='501' r='4' transform='rotate(90 1296 501)' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1296' cy='513' r='4' transform='rotate(90 1296 513)' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1296' cy='525' r='4' transform='rotate(90 1296 525)' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1296' cy='537' r='4' transform='rotate(90 1296 537)' fill='#162029' />
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1296' cy='549' r='4' transform='rotate(90 1296 549)' fill='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1283' cy='501' r='4' transform='rotate(90 1283 501)' fill='#162029' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1283' cy='513' r='4' transform='rotate(90 1283 513)' fill='#162029' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1283' cy='525' r='4' transform='rotate(90 1283 525)' fill='#162029' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1283' cy='537' r='4' transform='rotate(90 1283 537)' fill='#FF6969' />
            <circle className={`${styles.delay5} ${styles.opacity} ${lvl.includes(12) ? styles.animate : ''}`} cx='1283' cy='549' r='4' transform='rotate(90 1283 549)' fill='#162029' />
          </g>
          <circle className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.3' cx='1369' cy='29.6992' r='3' transform='rotate(180 1369 29.6992)' fill='#162029' />
          <circle className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.4' cx='1359' cy='29.6992' r='3' transform='rotate(180 1359 29.6992)' fill='#162029' />
          <circle className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.3' cx='1349' cy='29.6992' r='3' transform='rotate(180 1349 29.6992)' fill='#162029' />
          <circle className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.3' cx='1339' cy='29.6992' r='3' transform='rotate(180 1339 29.6992)' fill='#162029' />
          <circle className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.3' cx='1369' cy='21.6992' r='3' transform='rotate(180 1369 21.6992)' fill='#162029' />
          <circle className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.4' cx='1359' cy='21.6992' r='3' transform='rotate(180 1359 21.6992)' fill='#162029' />
          <circle className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.3' cx='1349' cy='21.6992' r='3' transform='rotate(180 1349 21.6992)' fill='#162029' />
          <circle className={`${styles.delay4} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.3' cx='1339' cy='21.6992' r='3' transform='rotate(180 1339 21.6992)' fill='#162029' />
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='1306'
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`} d='M1306 208.199C1306 182.599 1306 176.199 1306 176.199' stroke='#FF6969' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(6) ? styles.animate : ''}`} d='M1318 200.199C1318 174.599 1318 168.199 1318 168.199' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay1} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`} d='M1330 207.699C1330 175.699 1330 167.699 1330 167.699' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay4} ${styles.r_l} ${lvl.includes(6) ? styles.animate : ''}`} d='M1256 25.6992C1224.8 25.6992 1217 25.6992 1217 25.6992' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='1017' cy='560' r='2.25' transform='rotate(90 1017 560)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`} cx='973' cy='560' r='2.25' transform='rotate(90 973 560)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(11) ? styles.animate : ''}`} d='M1014 560C982.8 560 975 560 975 560' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
            ...
            <circle
              ...
              strokeWidth='1.5'
            />
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(6) ? styles.animate : ''}`} d='M1427 283.699C1427 251.699 1427 243.699 1427 243.699' stroke='#162029' />
          </g>
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(5) ? styles.animate : ''}`} opacity='0.4' d='M1008 258.699L1008 231.699' stroke='#162029' />
          <path className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(5) ? styles.animate : ''}`} opacity='0.4' d='M993 243.699L993 216.699' stroke='#162029' />
          <path className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(5) ? styles.animate : ''}`} opacity='0.4' d='M999 258.699L999 210.699' stroke='#162029' />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(2) ? styles.animate : ''}`} opacity='0.4' d='M408 405.699L408 348.699' stroke='#162029' />
          <path className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(2) ? styles.animate : ''}`} opacity='0.4' d='M393 360.699L393 333.699' stroke='#162029' />
          <path className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(2) ? styles.animate : ''}`} opacity='0.4' d='M399 375.699L399 327.699' stroke='#162029' />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(6) ? styles.animate : ''}`} opacity='0.4' d='M1351 276H1245' stroke='url(#paint59_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} d='M1327 284L1278 284' stroke='url(#paint60_linear_110_2)' />
          <path className={`${styles.delay1} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} d='M1340 268H1234' stroke='url(#paint61_linear_110_2)' />
          <path className={`${styles.delay3} ${styles.opacityH} ${lvl.includes(5) ? styles.animate : ''}`} opacity='0.4' d='M1190 57.6992L1190 42.6992' stroke='url(#paint62_linear_110_2)' />
          <path className={`${styles.delay2} ${styles.opacityH} ${lvl.includes(5) ? styles.animate : ''}`} opacity='0.4' d='M1194 57.6992L1194 37.6992' stroke='url(#paint63_linear_110_2)' />
          <path className={`${styles.delay1} ${styles.opacityH} ${lvl.includes(5) ? styles.animate : ''}`} opacity='0.4' d='M1186 57.6992L1186 46.6992' stroke='url(#paint64_linear_110_2)' />
          <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(5) ? styles.animate : ''}`} d='M1133.5 235L1133.5 315.5L1113.5 336L1107 336' stroke='url(#paint65_linear_110_2)' />
          <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1105' cy='336' r='2.25' transform='rotate(90 1105 336)' stroke='#ACCAD6' strokeWidth='1.5' />
          <circle className={`${styles.delay1} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1133' cy='233' r='2.25' transform='rotate(90 1133 233)' stroke='#FD6C6D' strokeWidth='1.5' />
          <g opacity='0.4'>
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1162' cy='290' r='2.25' transform='rotate(90 1162 290)' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay4} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`} cx='1145' cy='290' r='2.25' transform='rotate(90 1145 290)' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay5} ${styles.r_l} ${lvl.includes(5) ? styles.animate : ''}`} d='M1159 290C1149.4 290 1147 290 1147 290' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(5) ? styles.animate : ''}`} d='M1142.5 214.5L1142.5 264L1156 275L1175 275' stroke='#162029' />
            <path
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay5} ${styles.l_r} ${lvl.includes(6) ? styles.animate : ''}`} d='M1183.5 17.6992L1284 17.6992L1296 26.6992L1296 38.1992' stroke='#162029' />
            <path
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.l_r} ${lvl.includes(10) ? styles.animate : ''}`} d='M941.5 552L1042 552L1054 561L1054 572.5' stroke='#162029' />
            <path className={`${styles.delay2} ${styles.opacity} ${lvl.includes(10) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <circle
              ...
              stroke='#162029'
              strokeWidth='1.5'
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(4) ? styles.animate : ''}`}
            />
            <circle
              cx='878'
              cy='-1.30078'
          ...
          <g opacity='0.4'>
            <circle className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} cx='1221' cy='184.699' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <circle className={`${styles.delay3} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`} cx='1221' cy='201.699' r='2.25' stroke='#162029' strokeWidth='1.5' />
            <path className={`${styles.delay4} ${styles.b_t} ${lvl.includes(6) ? styles.animate : ''}`} d='M1221 187.699C1221 197.299 1221 199.699 1221 199.699' stroke='#162029' />
          </g>
          <g opacity='0.4'>
            <path
              className={`${styles.delay3} ${styles.b_t} ${lvl.includes(4) ? styles.animate : ''}`}
          ...
          <path className={`${styles.delay2} ${styles.r_l} ${lvl.includes(5) ? styles.animate : ''}`} d='M1112 388.699C1092.8 388.699 1088 388.699 1088 388.699' stroke='url(#paint66_linear_110_2)' />
          <circle
            className={`${styles.delay1} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`}
            cx='3'
            cy='3'
          ...
          />
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.l_r} ${lvl.includes(6) ? styles.animate : ''}`} d='M1282 338.699C1235.6 338.699 1224 338.699 1224 338.699' stroke='#162029' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay5} ${styles.r_l} ${lvl.includes(6) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`} d='M1211 186.699C1211 233.099 1211 244.699 1211 244.699' stroke='#162029' />
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`} d='M1221 215.699C1221 262.099 1221 273.699 1221 273.699' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay4} ${styles.r_l} ${lvl.includes(6) ? styles.animate : ''}`} d='M1233 443.199H1299L1361 381.199' stroke='black' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay3} ${styles.b_t} ${lvl.includes(5) ? styles.animate : ''}`} d='M1091.44 308.396L1044.77 261.727L1044.77 174.046' stroke='black' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(5) ? styles.animate : ''}`}
              cx='1044.42'
              cy='171.571'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(6) ? styles.animate : ''}`} d='M1227 435.199H1293L1355 373.199' stroke='black' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`} d='M1407.25 445.043C1383.25 469.043 1377.25 475.043 1377.25 475.043' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`} d='M1410.25 456.043C1393.45 472.843 1389.25 477.043 1389.25 477.043' stroke='#162029' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay5} ${styles.r_l} ${lvl.includes(6) ? styles.animate : ''}`} d='M1281.87 425.699C1258.11 425.699 1252.17 425.699 1252.17 425.699' stroke='#162029' />
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay3} ${styles.r_l} ${lvl.includes(6) ? styles.animate : ''}`} d='M1245 33.6992C1230.6 33.6992 1227 33.6992 1227 33.6992' stroke='#162029' />
            <circle
              className={`${styles.delay2} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.4'>
            <path className={`${styles.delay4} ${styles.l_r} ${lvl.includes(11) ? styles.animate : ''}`} d='M1003 568C988.6 568 985 568 985 568' stroke='#162029' />
            <circle
              className={`${styles.delay3} ${styles.opacity} ${lvl.includes(11) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay5} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`} d='M1432.34 447.031C1399.53 479.84 1391.33 488.043 1391.33 488.043' stroke='#162029' />
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.3'>
            <path className={`${styles.delay5} ${styles.b_t} ${lvl.includes(6) ? styles.animate : ''}`} d='M1335.34 376.031C1302.53 408.84 1294.33 417.043 1294.33 417.043' stroke='#162029' />
            <circle
              className={`${styles.delay4} ${styles.opacity} ${lvl.includes(6) ? styles.animate : ''}`}
              cx='3'
              cy='3'
          ...
          <g opacity='0.3'>
            <path
              className={`${styles.delay3} ${styles.l_r} ${lvl.includes(5) ? styles.animate : ''}`}
          ...
          <g opacity='0.3'>
            <path
              className={`${styles.delay3} ${styles.t_b} ${lvl.includes(6) ? styles.animate : ''}`}
          ...
          <g opacity='0.4'>
            <path
              className={`${styles.delay3} ${styles.t_b} ${lvl.includes(5) ? styles.animate : ''}`}
          ...
          <g opacity='0.15'>
            <path
              className={`${styles.delay4} ${styles.l_r} ${lvl.includes(5) ? styles.animate : ''}`}
