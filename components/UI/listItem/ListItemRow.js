        ...
        <div className={styles.TableRow__item}>
          ...
          <div className={styles.TableRow__to}>
            ...
            <div className={styles.TableRow__date}>
              ...
              <p>{data.dateTime}</p>
              <Link href={`/sometransaction`}>
                <svg className={styles.TableRow__link} width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      >
        ...
        <div className={styles.display}>
          ...
          <div className={styles.readMore}>
            <Link href={`/proposal`} className="font_13">Read More</Link>
            <svg
              width="12"
              height="10"
              viewBox="0 0 12 10"
