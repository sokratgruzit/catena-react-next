...
const Tooltip = (props) => {
    ...
    if (props.type === "dashboard") {
        tooltip =  <div
            className={`${styles.dashboardTooltipContainer} ${styles.tooltipContainer} ${activeTooltip ? styles.activeTooltip : ''}`}
        >
            <div
    ...
    if (props.type === "settings") {
        tooltip =  <div
            className={`${styles.settingsTooltipContainer} ${styles.tooltipContainer} ${activeTooltip ? styles.activeTooltip : ''}`}
        >
            <div
                className={styles.tooltipBtn}
            >
