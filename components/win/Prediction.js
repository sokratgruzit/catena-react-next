...
const Prediction = () => {
    ...
    const [activeMenuItem, setActiveMenuItem] = useState("Prediction");
            ...
            <div className={`${styles.sliderMainConteinerExpierd}`}>
                    ...
                    <div>                                
                        <span>
                            <svg width="10" height="13" viewBox="0 0 10 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.31793 5.21512L4.74735 1.64453L1.17676 5.21512" stroke="#66BB6A" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M4.74707 11.6441V1.74414" stroke="#66BB6A" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </span>
                        <p>
                ...
                <div className={styles.priceDownContainer}>
                    ...
                    <div className={styles.priceDownExpierd}>
                        ...
                        <span>
                            <svg width="10" height="13" viewBox="0 0 10 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.81891 8.07394L5.24832 11.6445L1.67773 8.07394" stroke="#E94A4A" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M5.24805 1.64492V11.5449" stroke="#E94A4A" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </span>
                    </div>
                </div>
                    ...
                    <div className={`${activeBtns === item.id ? styles.containerOpacity : ''} ${activeBtnsDwn === item.id ? styles.containerOpacity : ''} `}>
                        <div className={styles.titleNext} >
                            <div>
                                <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <path d="M5.35059 5.18904V9.10057C5.35059 9.90167 6.22118 10.4044 6.91601 10.0039L8.61224 9.027L10.3085 8.04605C11.0033 7.64549 11.0033 6.64411 10.3085 6.24356L8.61224 5.26261L6.91601 4.28575C6.22118 3.8852 5.35059 4.38384 5.35059 5.18904V5.18904Z" fill="#0500FF"/>
                                </svg>
                        ...
                        <div className={styles.lastPriceNextBorder}>
                            ...
                            <div>
                                ...
                                <button className={styles.downBottom}
                                    onClick={() => {
                                        activateDwn(item.id);
                                    }} >Enter DOWN
                                </button>
            ...
            <SwiperSlide key={item.id}>
                <div className={`${styles.sliderMainContainer}`}>
                    ...
                    <div className={styles.laterBorderContent}>
                        <div className={styles.laterBorder}>
                            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M12.6833 7.14388C12.6833 10.3639 10.0699 12.9772 6.84994 12.9772C3.62994 12.9772 1.0166 10.3639 1.0166 7.14388C1.0166 3.92388 3.62994 1.31055 6.84994 1.31055C10.0699 1.31055 12.6833 3.92388 12.6833 7.14388Z" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M9.01379 8.99858L7.20546 7.91941C6.89046 7.73275 6.63379 7.28358 6.63379 6.91608V4.52441" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                            <p>
                                Later
                            </p>
                    ...
                    <div className={styles.upLater}>
                        <svg width="10" height="13" viewBox="0 0 10 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.31891 5.21512L4.74832 1.64453L1.17773 5.21512" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                            <path d="M4.74805 11.6441V1.74414" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                        <p>
                            UP
                        </p>
                    ...
                    <div className={styles.entryStarts}>
                        <div>
                            <p className={styles.entryStartsTitle}>
                                Entry Starts
                            </p>
                            <p>
                                ~09:32
                    ...
                    <div className={styles.downLater}>
                        <p>
                            DOWN
                            <svg width="10" height="13" viewBox="0 0 10 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M8.81891 8.07394L5.24832 11.6445L1.67773 8.07394" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M5.24805 1.64492V11.5449" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                            </svg>
                        </p>
                    </div>
                </div>    
