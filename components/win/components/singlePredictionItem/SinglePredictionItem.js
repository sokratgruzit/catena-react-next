  ...
  return (
    <div className={`${styles.sliderMainConteinerExpierd}`}>
        ...
        <> 
          ...
          <div className={styles.buttonContent}>
            ...
            <div className={styles.enterButton}>
              <p className={styles.enterUp}>Enter UP</p>
              <p className={styles.enterDown}>Enter DOWN</p>
            </div>
          </div>
           <div className={styles.priceDownContainer}>
                <p>{item.payDown}</p>
      ...
      {item.action === 'later' && (
          ...
          <path d="M8.53668 4.58231L4.9661 1.01172L1.39551 4.58231" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M4.96582 11.0113V1.11133" stroke="white" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        UP</p>
      )}
