      ...
      <div className={`${styles.tab} ${activebtns === false ? styles.containerOpacity : ''}`}>
        <div className={styles.border}>
          ...
          <div className={styles.mainContent}>
            ...
            <div className={styles.costBorder}>
              ...
              <p>
                <svg width='10' height='4' viewBox='0 0 10 4' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  <path
                    d='M1 1.68263C4.4284 5.72434 4.6972 -1.08444 9 1.68263'
                    stroke='#BFC0C3'
                    strokeLinecap='round'
                  />
                </svg>
            ...
            <p>
              `&ldquo;`Buy Instantly`&rdquo;` chooses random numbers, with no duplicates among your tickets. Prices are
              set before each round starts, equal to $5 at that time. Purchases are final.
            </p>
          </div>
        </div>
      </div>
