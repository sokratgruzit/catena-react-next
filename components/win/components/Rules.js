    ...
    <>
        <div>
            <div className={styles.rulesIcones}>
                <div>
                    <svg width="27" height="31" viewBox="0 0 27 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M5.42292 13.1374C4.67171 13.1914 3.91751 13.0856 3.21127 12.8273C2.50502 12.569 1.86317 12.1642 1.32906 11.6402C-0.414391 9.8618 0.130632 7.3623 0.130632 7.3623C1.65771 7.45507 3.09408 8.10921 4.15636 9.19567C4.67268 9.7041 5.05733 10.3277 5.27779 11.0138C5.49825 11.6999 5.54803 12.4283 5.42292 13.1374Z" fill="#627EEA"/>
            ...
            <div className={styles.rulesDescription}>
                <div className={styles.rules}>
                    <div >
                       <h4>Trade to increase your rank</h4>
                        <p>
                            Eligible pairs: SANTOS/BNB,
                            PORTO/BNB, LAZIO/BNB, SANTOS/BUSD, 
                            PORTO/BUSD, LAZIO/BUSD, CMCX/BNB and CMCX/BUSD
                        </p>
                    </div>
                </div>
                    <span>
                        ...
                        <defs>
                        <linearGradient id="paint0_linear_1537_5961" x1="0.414093" y1="200.827" x2="0.41408" y2="0.827148" gradientUnits="userSpaceOnUse">
                ...
                <div>
                    <h4 className={styles.everyone}>
                        Everyone’s a winner!
                    </h4>
                    <p>
                        Sign up for battle and you’re guaranteed a prize!
                    </p>
                </div>
            </div>
        </div>
        <div className={styles.finishedRules}>
            <div className={styles.Rules__background}>
                <Image
                    ...
                    layout="fill"
                    alt="rulesBk"
                    src="/images/win/background/rulesBackground.png"
                />
            </div>
            <div>
