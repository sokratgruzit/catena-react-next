    ...
    <div className={styles.mainContent}>
      <div>
        ...
        <div className={styles.tickets}>
          <Image
            layout='fill'
            objectFit='contain'
            src={`/images/win/ticketsIcone.png`}
            alt=''
          />
        </div>
      </div>
      ...
      <div className={styles.description}>
        <div>
          ...
          <p>
            ...
            <span className={styles.spanOpacity}>
              The first 3 digits and the last 2 digits match, but the 4th digit
        ...
        <div className={styles.paragphB}>
          ...
          <p>
            Ticket B:
            <span className={styles.spanOpacity}>
              Even though the last 5 digits match, the first digit is wrong, so
      ...
      <div className={styles.prizeBrackets}>
        <p>
          ...
          &#x2018;Match 3&#x2019; bracket, and not from &#x2018;Match 1&#x2019;
          and &#x2018;Match 2&#x2019;.
        </p>
      </div>
    </div>
