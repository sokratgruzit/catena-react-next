        ...
        <>
            <div className={styles.mainContainer}>
                ...
                <div className={styles.content}>
                    ...
                    <div>
                        <p className={styles.desTitle}>
                            Ticket Purchases
                        </p>
                        <p className={styles.description}>
                            <svg width="9" height="9" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <ellipse cx="4.57144" cy="4.74707" rx="4.15738" ry="4" fill="#0500FF"/>
                            </svg>
                    ...
                    <div>
                        ...
                        <p className={styles.description}>
                            ...
                            An average total of 35,000 CAKE from the treasury is added to lottery rounds over the course of a week. This CAKE is of course also included in rollovers! Read more in our guide to <a className={styles.links} href="#">CORE Tokenomics</a> 
                        </p>
                    </div>
                </div>
