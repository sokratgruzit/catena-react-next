...
function Stack() {
  const { disconnect, account, isActive, library, handleWalletModal } = useConnect();
                      ...
                      <div className="btn">
                        ...
                        <div className="popover__content">
                          <div className="product-body">
                            <button className="color" onClick={() => disconnect()}>
              ...
              <div className="stack-box__double">
                ...
                <div className="half">
                  <div className="stack-box">
                    ...
                    <div className="stack">
                      <p>CMCX Earned</p>
                      <h3>{parseFloat(stakersInfo.realtimeReward).toFixed(10)} CMCX</h3>
                    </div>
                    <div className="stack">
                      <p>Claimed Reward</p>
                      <h3>
                        {parseFloat(stakersInfo.totalClaimedRewardTokenUser).toFixed(5)}{" "}
                        CMCX
                      </h3>
                    </div>
                  </div>
                ...
                <div className="half">
                  <div className="stack-box">
                    <div className="stack">
                      ...
                      <h3 style={{ color: "#0500FF" }}>{balance.toFixed(5)} CMCX</h3>
                    </div>
                    <div className="stack">
                      <p>Total Stacked</p>
                      <h3>
                  ...
                  stakersRecord.map((row, index) => {
                    return (
                      <tr key={index}>
                        ...
                        <td>CMCX</td>
                        <td>{parseFloat(row.realtimeRewardPerBlock).toFixed(10)}</td>
                        <td>
                          {row.unstaked ? (
                            <button
                              disabled={true}
