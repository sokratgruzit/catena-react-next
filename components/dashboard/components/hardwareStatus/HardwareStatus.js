...
const HardwareStatus = () => {
  return (
    <div className={styles.container}>
      <h3 className={styles.title} data-aos='fade-up' data-aos-delay='20'>
        HARDWARE{' '}
        ...
        <svg width='3' height='15' viewBox='0 0 3 15' fill='white' xmlns='http://www.w3.org/2000/svg'>
      ...
      <div className={styles.hardwareStatsWrap} data-aos='fade-up' data-aos-delay='20'>
        <div className={styles.hardwareStatsItem}>
          <span className={styles.CPUstats}>
            <CPUstats label={'RAM'} />
          </span>
          <div className={styles.rigth}>
            ...
            <div className={styles.rightMoreDetails}>
              <div>
                <h4>Total:</h4>
                <p> - kb</p>
              </div>
