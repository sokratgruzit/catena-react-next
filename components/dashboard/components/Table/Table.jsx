...
import {
  Table as TableUI,
  TableElement as TableElementUI,
} from "@catena-network/catena-ui-module";
      ...
      <div
        ...
        <div
          ...
          <div
            ...
            style={{
              width: `${
                mobile ? delegatorsTh[0].mobileWidth : delegatorsTh[0].width
              }%`,
              height: "88px",
            }}>
          ...
          <div
            ...
            style={{
              width: `${
                mobile ? delegatorsTh[1].mobileWidth : delegatorsTh[1].width
              }%`,
              height: "88px",
            }}>
            <div className='table-coin-row' style={{ gap: "10px" }}>
          ...
          <div
            ...
            style={{
              width: `${
                mobile ? delegatorsTh[2].mobileWidth : delegatorsTh[2].width
              }%`,
              height: "88px",
            }}>
            <div className='table-coin-row'>
              <div className={styles.tablePercentageChartWrap}>
                <span
                  className={styles.tablePercentageChart}
                  style={{ width: "1%" }}
                />
              </div>
        ...
        <div
          ...
          style={{
            background: `${
              mobileExpand == item._id ? "rgb(255, 255, 255, 0.06)" : "none"
            }`,
            backdropFilter: `${
              mobileExpand == item._id ? "blur(5px)" : "none"
            }`,
            borderBottom: "none",
            display: "flex",
            height: "88px",
    ...
    return (
      <div
        ...
        <div className='table'>
          <div
            className={`td col ${
              validatedBlocksTh[0].mobileWidth ? true : false
            }`}
            style={{
              width: `${
                mobile
                  ? validatedBlocksTh[0].mobileWidth
                  : validatedBlocksTh[0].width
              }%`,
              height: "88px",
          ...
          <div
            className={`td col ${
              validatedBlocksTh[1].mobileWidth ? true : false
            }`}
            style={{
              width: `${
                mobile
                  ? validatedBlocksTh[1].mobileWidth
                  : validatedBlocksTh[1].width
              }%`,
              height: "88px",
              color: "rgba(255, 255, 255, 0.7)",
            }}>
          ...
          <div
            className={`td col ${
              validatedBlocksTh[2].mobileWidth ? true : false
            }`}
            style={{
              width: `${
                mobile
                  ? validatedBlocksTh[2].mobileWidth
                  : validatedBlocksTh[2].width
              }%`,
              height: "88px",
              color: "rgba(255, 255, 255, 0.7)",
            }}>
          ...
          <div
            className={`td col ${
              validatedBlocksTh[3].mobileWidth ? true : false
            }`}
            style={{
              width: `${
                mobile
                  ? validatedBlocksTh[3].mobileWidth
                  : validatedBlocksTh[3].width
              }%`,
              height: "88px",
              color: "rgba(255, 255, 255, 0.7)",
            }}>
          ...
          <div
            className={`td col ${
              validatedBlocksTh[4].mobileWidth ? true : false
            }`}
            style={{
              width: `${
                mobile
                  ? validatedBlocksTh[4].mobileWidth
                  : validatedBlocksTh[4].width
              }%`,
              height: "88px",
              color: "rgba(255, 255, 255, 0.7)",
            }}>
