            ...
            <div className={styles.dashboardMid__checkbox}>
              <div className="radio-btn">
                ...
                <div className="radio-btn__inner">
                  <div className="radio-btn__icon">
                  </div>
                </div>
                Staked only
              </div>
            </div>
            <input type="search" placeholder="Search Farms" className={styles.sliderHeader__search}></input>
          </div>
          <Swiper
            spaceBetween={100}
            slidesPerView={"auto"}
                ...
                <div className={styles.dashboardMid__slider}>
                  <div className={styles.dashboardMid__slide}>
                    ...
                    <div className={styles.dashboardMid__flex}>
                      <span className="font_13">Available:&nbsp;</span> <p className="font_13">345.400214</p>
                      <span className="font_13">Stake:&nbsp;</span> <p className="font_13">30</p>
                    </div>
                    <div className={`${styles.dashboardMid__flex} ${styles.dashboardMid__flexLast} font_13`}>
                    ...
                    <div className={`${styles.dashboardMid__flex} ${styles.sliderButtons}`}>
                      <button
