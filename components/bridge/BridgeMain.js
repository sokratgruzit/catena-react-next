...
function BridgeMain() {
        ...
        <div className='bridge__box-main'>
          <div className='bridge__box-selects'>
            <div className='bridge__box-select-out'>
              <div className='bridge__box-select-ttl font-13'>from</div>
                    ...
                    <p>
                      ...
                      <svg width='8' height='6' viewBox='0 0 8 6' fill='none' xmlns='http://www.w3.org/2000/svg'>
                        <path
                          fillRule='evenodd'
                          clipRule='evenodd'
                          d='M0.21967 1.16742C0.512563 0.874531 0.987437 0.874531 1.28033 1.16742L3.75 3.63709L6.21967 1.16742C6.51256 0.874531 6.98744 0.874531 7.28033 1.16742C7.57322 1.46032 7.57322 1.93519 7.28033 2.22808L4.81063 4.69778C4.22607 5.28234 3.27393 5.28234 2.68937 4.69778L0.21967 2.22808C-0.0732233 1.93519 -0.0732233 1.46032 0.21967 1.16742Z'
                          fill='white'
                        />
                      </svg>
                    </p>
            ...
            <div className='bridge__swap-btn' onClick={() => switchNetwork()}>
              <svg width='16' height='14' viewBox='0 0 16 14' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <path
                  d='M1.63293 9.23926L5.38574 12.9996'
                  stroke='white'
                  strokeWidth='1.5'
                  strokeMiterlimit='10'
                  strokeLinecap='round'
                ...
                />
                <path
                  d='M14.3672 9.23926L1.63311 9.23926'
                  stroke='white'
                  strokeWidth='1.5'
                  strokeMiterlimit='10'
                  strokeLinecap='round'
                ...
                />
                <path
                  d='M1.63311 4.76074L14.3672 4.76074'
                  stroke='white'
                  strokeWidth='1.5'
                  strokeMiterlimit='10'
                  strokeLinecap='round'
            ...
            <div className='bridge__box-select-out'>
              <div className='bridge__box-select-ttl font-13'>to</div>
              <div className='bridge__box-select'>
                <div className='bridge__box-select-inner'>
                  <div className='bridge__box-select-main'>
                    <p>
          ...
          <div className='bridge__box-sec-floor'>
            <div className='bridge__box-assets'>
              <div className='bridge__box-select-ttl font-13'>Assets</div>
              <div className='bridge__box-assets-btn'>
                ...
                <svg width='8' height='5' viewBox='0 0 8 5' fill='none' xmlns='http://www.w3.org/2000/svg'>
                  <path
                    fillRule='evenodd'
                    clipRule='evenodd'
                    d='M0.21967 0.625432C0.512563 0.332538 0.987437 0.332538 1.28033 0.625432L3.75 3.0951L6.21967 0.625432C6.51256 0.332538 6.98744 0.332538 7.28033 0.625432C7.57322 0.918325 7.57322 1.3932 7.28033 1.68609L4.81063 4.15579C4.22607 4.74035 3.27393 4.74035 2.68937 4.15579L0.21967 1.68609C-0.0732233 1.3932 -0.0732233 0.918325 0.21967 0.625432Z'
                    fill='white'
                  />
                </svg>
              </div>
            ...
            <div className='bridge__box-amount'>
              <div className='bridge__box-select-ttl font-13'>Amount</div>
              <input
                type='number'
                placeholder='0.0000'
                value={swapAmount}
          ...
          <div className='bridge__box-destination'>
            <div className='bridge__box-select-ttl font-13'>Destination</div>
            <div className='bridge__box-destination-inner'>
              <input type='text' placeholder='Enter destination' />
              <span>or</span>
              <div className='bridge__box-destination-btn'>Connect Second Wallet</div>
            </div>
          </div>
          {isActive ? (
            chainId === 4 || chainId === 97 ? (
              allowance ? (
                <button type='button' className='sr-btn-2' onClick={() => approve()} disabled={loading}>
              ...
              <div>
                <button type='button' className='sr-btn-2'>
                  swich network to eth or bsc
                </button>
              </div>
            )
          ) : (
            <div className='bridge__box-connect-btn' onClick={() => handleWalletModal(true)}>
              Connect Wallet
            </div>
          )}
        </div>
      ...
      <div className='bridge__box'>
        ...
        <div className='bridge__box-checked-selects'>
          ...
          <svg width='27' height='16' viewBox='0 0 27 16' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path
              d='M18.9277 1.35916L25.4982 7.92958L18.9277 14.5'
              stroke='#0500FF'
              strokeWidth='1.5'
              strokeMiterlimit='10'
              strokeLinecap='round'
            ...
            />
            <path
              d='M1.5 7.92969L25.3166 7.92969'
              stroke='#0500FF'
              strokeWidth='1.5'
              strokeMiterlimit='10'
              strokeLinecap='round'
          ...
          <div className='bridge__box-info'>
            ...
            <div className='bridge__box-info-descr'>
              ...
              <span className='font-13'>
                Transaction ID: <a href='##'>0xC7...061b</a>
              </span>
            </div>
          </div>
          <div className='bridge__box-info'>
  ...
  return (
    <div className='bridge__body'>
      ...
      <div className='box-section'>
        <div className='balence'>
          ...
          <div className='font-icon'>
            ...
            <div className='round12' onClick={() => switchNetwork()}>
          ...
          <div>
            <div>
              <div className='round'>
                <div className='box'>
                  <p>You Receive</p>
                  <input type='number' placeholder='0.0000' value={outputAmount} readOnly></input>
                  <div className='icon'>
                    <img src={activeNetwork2?.logo} alt='' />
                    <span>{activeNetwork2?.name}</span>
                  </div>
              ...
              {isActive ? (
                chainId === 4 || chainId === 97 ? (
                  allowance ? (
                    ...
                    <button type='button' className='sr-btn-2' onClick={() => swapBalance()} disabled={loading}>
                ...
                <button type='button' className='sr-btn-2' onClick={() => handleWalletModal(true)}>
                  Connect Wallet
                </button>
              )}
            </div>
      ...
      >
        <HalfMalf
          text={'Do not close or refresh this window while processing the transaction.'}
          bgColor={'#ffff'}
          width={'250px'}
          height={'250px'}
          center={true}
