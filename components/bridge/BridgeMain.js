...
function BridgeMain() {
  const { isActive, account, library, handleWalletModal, chainId, providerType } =
    useMetaMask();
      ...
      <div className="bridge__section bridge__section-step1">
        <div className="bridge__inner">
          <div className="bridge__steps">
            <div
              className={`bridge__step progress-step ${step > 0 ? "active-step" : ""}`}
            >
            ...
            <div
              className={`bridge__step progress-step step2 ${
                step > 1 ? "active-step" : ""
              }`}
            >
            ...
            <div
              className={`bridge__step progress-step step3 ${
        ...
        <div className="balence">
          ...
          <div className="font-icon">
            <h4>
              ...
              {activeNetwork1?.percentage === 0
                ? 1
                : 1 - 1 * (activeNetwork1?.percentage / 100)}{" "}
            </h4>
