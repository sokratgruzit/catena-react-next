            ...
            <header className={`${styles.header} container`}>
                <div className={styles.headerInner}>
                        ...
                        {NAV_DATA.map((item) => {
                            return (
                                ...
                                >
                                    ...
                                    <div className={`${styles.headerNavLinkSubTtl} ${activeMenu === item.id ? styles.activeMenuSub : ''}`}>
                                        <i className={activeMenu === item.id ? styles.activeBg : ''}></i>
                                        {item.subNav.map((sub, index) => {
                                            return (
                                                <a href={sub.route} key={sub.id}><div style={{transitionDelay: (activeMenu === item.id ? `${(index + navTransaction) / 10}s` : '')}}><span>{sub.title}</span></div></a>
                                            )
                                        })}
                                    </div>
                                </div>
                    ...
                    <div className={styles.headerRightOuter}>
                        <div className={`${styles.headerRight} ${activeMenu !== null ? styles.headerRightHideToRight : ''} ${walletModal || activeLangs || activeSettings ? styles.headerRightHideToLeft : ''}`}>
                            ...
                            <div className={styles.headerConnected}>
                                <div
                                ...
                                >
                                    <div className={styles.headerConnectedBtnImg}>
                                        <img src={`./images/meta.png`} alt="avatar"/>
                                        <i></i>
                                    </div>
                                    <span>0x7de7de44e2667bdef602fd069bcef02f1c167825</span>
                                    <svg width="8" height="5" viewBox="0 0 8 5" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path fillRule="evenodd" clipRule="evenodd" d="M0.59467 0.223576C0.887563 -0.0693171 1.36244 -0.0693171 1.65533 0.223576L4.125 2.69325L6.59467 0.223576C6.88756 -0.0693171 7.36244 -0.0693171 7.65533 0.223576C7.94822 0.516469 7.94822 0.991343 7.65533 1.28424L5.18563 3.75393C4.60107 4.33849 3.64893 4.33849 3.06437 3.75393L0.59467 1.28424C0.301777 0.991343 0.301777 0.516469 0.59467 0.223576Z" fill="white"/>
                                    </svg>
                                </div>
                            </div>
                        </div>
                ...
                <div className={`${styles.headerConnectedModal} ${profileModal ? styles.headerConnectedModalActive : ''}`}>
                    <div className={styles.headerConnectedModalInner}>
                        ...
                        <i></i>
                        <a href="/disconnect-wallet" className={styles.headerConnectedModalLink}>
                            <span>Disconnect Wallet</span>
                            <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g>
                                    <path d="M12.231 9.79986C12.079 9.79986 11.927 9.74386 11.807 9.62386C11.6954 9.51095 11.6328 9.3586 11.6328 9.19986C11.6328 9.04111 11.6954 8.88877 11.807 8.77586L13.431 7.15186L11.807 5.52786C11.6954 5.41495 11.6328 5.2626 11.6328 5.10386C11.6328 4.94511 11.6954 4.79277 11.807 4.67986C12.039 4.44786 12.423 4.44786 12.655 4.67986L14.703 6.72786C14.935 6.95986 14.935 7.34386 14.703 7.57586L12.655 9.62386C12.535 9.74386 12.383 9.79986 12.231 9.79986Z" fill="#898C92"/>
                                    <path d="M14.2204 7.75176H6.08437C5.75637 7.75176 5.48438 7.47976 5.48438 7.15176C5.48438 6.82376 5.75637 6.55176 6.08437 6.55176H14.2204C14.5484 6.55176 14.8204 6.82376 14.8204 7.15176C14.8204 7.47976 14.5484 7.75176 14.2204 7.75176Z" fill="#898C92"/>
                                    <path d="M7.6875 14.1035C3.5675 14.1035 0.6875 11.2235 0.6875 7.10352C0.6875 2.98352 3.5675 0.103516 7.6875 0.103516C8.0155 0.103516 8.2875 0.375516 8.2875 0.703516C8.2875 1.03152 8.0155 1.30352 7.6875 1.30352C4.2715 1.30352 1.8875 3.68752 1.8875 7.10352C1.8875 10.5195 4.2715 12.9035 7.6875 12.9035C8.0155 12.9035 8.2875 13.1755 8.2875 13.5035C8.2875 13.8315 8.0155 14.1035 7.6875 14.1035Z" fill="#898C92"/>
                                </g>
                            </svg>
                        </a>
                    </div>
                ...
                <div
                    className={`${styles.headerLangOptions} ${activeLangs ? styles.headerLangOptionsActive : ''}`}
                    onMouseLeave={() => {
                        openLangs(false);
                    }}
                >
                    <i></i>
                    {
                        LANG_DATA.map((item,index) => {
                            return (
                                <div
                                    className={styles.headerLangOptionParent}
                                    key={item.id}
                                    onClick={() => {
                                        openLangs(false);
                                        changeLanguage(item.title);
                                    }}>
                                    <div style={{transitionDelay: activeLangs ? `${(index + 2) / 10}s` : ''}}>
                ...
                <div
                    className={`${styles.headerCornerModal} ${walletModal ? styles.connectWalletActive : ''}`}
                >
                    <i></i>
                            ...
                            WALLETS_DATA.map((item,index) => {
                                return (
                                    <div
                                        ...
                                        key={item.id}
                                        style={{transitionDelay: walletModal ? `${(index + 2) / 10}s` : ''}}
                                        onClick={() => {
                                            connect(item.type);
                                        }}
                                    >
                ...
                <div className={`${styles.headerLine} ${activeMenu !== null || activeLangs || activeSettings || walletModal ? styles.headerLineActive : ''}`}></div>
            </header>
            <div
