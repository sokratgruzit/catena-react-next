                                ...
                                <>
                                    <div className={styles.circleTitle}>
                                        ...
                                        <div className={styles.stepChart}>
                                            {index !== 0 && <div className={styles.boardLine} style={{backgroundColor: userData?.step >= index && "black"}} ></div>}
                                            <div className={styles.circle} style={{backgroundColor: userData?.step >= index && "A6D0DD", backgroundColor: userData?.step >= index && "black"}} onClick={() => userData?.step >= index && handleStep(index + 1)}>
