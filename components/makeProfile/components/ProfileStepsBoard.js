        ...
        <>
            <div className={styles.contHead}>
                ...
                <div className={styles.board}>
                    ...
                    {/* <div className={styles.ng_modal_number_container}>
                        <div className={styles.questionNumbers} ng-repeat="item in numberOfQuestions">
                            <div className={styles.questionNumberIcon}></div>
                            <div className={styles.questionNumberIcon}></div>
                            <div className={styles.questionNumberIcon}></div>
                            <div className={styles.questionNumberIcon}></div>
                            <div className={styles.questionNumberLine}></div>
                        </div>
                    </div> */}
                </div>
                <div className={styles.Line}></div>
