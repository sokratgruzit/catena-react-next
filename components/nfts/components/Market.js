  ...
  return (
    <div className='container'>
      <div className={styles.Market}>
        <div className={styles.Market__background}></div>
        <div className={styles.Market__containers}>
          <div className={styles.Market__searchBlock}>
            <div className={styles.Market__searchBoxTitles}>
              <p className={`${styles.Market__title} font_51`}>
          ...
          <div className={styles.Market__asstronaut}>
            ...
            <div className={styles.imageWrapper}>
              <div className={styles.Market__asstronautFigureBg}>
            ...
            <div className={styles.Market__planet3}>
              <svg width='133' height='109' viewBox='0 0 133 109' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <g clip-path='url(#clip0_1529_22972)'>
                  <path
            ...
            <div className={styles.Market__planet4}>
              <svg width='93' height='93' viewBox='0 0 93 93' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <g clip-path='url(#clip0_1529_22974)'>
                  <path
