  ...
  return (
    <div className={`${styles.mane} container`}>
      <div className={`${styles.box} container_bordered-child `}>
        <div className={`${styles.containerOne}  container_bordered-child `}>
        ...
        <div className={`${styles.containerTwo}  container_bordered-child`}>
        ...
        <div className={`${styles.containerThree} container_bordered-child`}>
