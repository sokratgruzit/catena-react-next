    ...
    <div>
       <div data-aos="fade-up" className="guidline__color-circle-container">
          ...
          <div data-aos="fade-up" className="pB-160 right guidline__color-circle-container">
            <div className="guidline__color-circle-item">
              <div className="guidline__color-circle" style={{background: "rgb(255,142,117)",background: "linearGradient(0deg, rgba(255,142,117,1) 0%, rgba(255,142,117,1) 100%)"}}></div>
              <div className="guidline__color-circle-title">FF8E75 → 9F402B</div>
            </div>
            <div className="guidline__color-circle-item">
              <div className="guidline__color-circle" style={{background: "rgb(138,136,255)",background: "linearGradient(180deg, rgba(138,136,255,1) 0%, rgba(5,0,255,1) 100%)"}}></div>
              <div className="guidline__color-circle-title">8A88FF → 0500FF</div>
            </div>
            <div className="guidline__color-circle-item">
              <div className="guidline__color-circle" style={{background:"rgb(213,213,255)", background: "linearGradient(180deg, rgba(213,213,255,1) 0%, rgba(139,139,198,1) 100%)"}}></div>
