        ...
        <div className="bottom__description">
          <div className="bottom__description-floor">
            <div className="bottom__description-item">
              ...
              <div>
                CORE Multi-Chain — Cryptographic Object Resources Engine
              </div>
            </div>
            <div className="bottom__description-item">
          ...
          <div className="bottom__description-floor">
            <div className="bottom__description-item">
              <div className="bottom__description-ttl">
                Native Crypto Symbol
              </div>
          ...
          <div className="bottom__description-floor">
            <div className="bottom__description-item">
              ...
              <div className="bottom__description-text">
                Practical Proof of Stake
              </div>
            </div>
            <div className="bottom__description-item">
