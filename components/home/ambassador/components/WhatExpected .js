            ...
            <div className={`${styles.ulTxt}  text`}>
                ...
                <ul>
                    <li>
                        ...
                        documents and more. This content will also have to be translated into a number of languages such as Mandarin, German, Spanish,
                        French, Russian, and a few other languages.
                    </li>
                </ul>
                <ul>
                ...
                <ul>
                    <li>Help us with our global community in multiple languages and on several channels such as Kakao, Telegram, WeChat, etc.</li>
                </ul>
                <ul>
                ...
                <ul>
                    <li>
                        There are plenty of rewards to win! All you have to do
                        is complete once-off tasks such as translating blog posts,
                        create virtual stickers, and help build our online presence among other things.
                    </li>
                </ul>
                <ul>
                ...
                <ul>
                    <li>Collaborate with various community stakeholders such as foundations, startup incubators, and university groups to co-host events.</li>
                </ul>
                <ul>
                    <li>Invite local guest speakers and professors to host interview sessions or sessions within university classes.</li>
                </ul>
            </div>
        </div>
    );
