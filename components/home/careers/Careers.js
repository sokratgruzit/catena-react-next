...
const senorUx = [
  {
    title: "CORE Multichain is a blockchain ecosystem that will enable all blockchain projects and the blockchain space as a whole to thrive by addressing all of the most considerable limitations of blockchain technology, such as scalability and interoperability. "
  },
  {
    title: "Are you looking to be a part of a revolutionary blockchain ecosystem that will unlock blockchain technology's unexplored potential and contribute to the cryptocurrency revolution that is busy changing the world? "
  }
]
...
const designPresentations = [
  ...
  {
    title: "Create high-quality UX design solutions through sketches, wireframes, designs, flow diagrams, storyboards, and site maps by analyzing product requirements."
  },
  {
  ...
  {
    title: "Ensure smooth implementation of discovered design optimization points and any identified methods to improve design systems."
  },
  {
...
const Careers = () => {
  return (
    <div>
      ...
      <JobResponsibilities requirements={benefitsList} title="Benefits" description="Here are some of the benefits that you'll receive on successful recruitment:" />
