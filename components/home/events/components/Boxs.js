...
const Boxs = () => {
    const eventsArr = [
        ...
        },
        {
            ...
            imgPartTwo: '/images/event/digital.png',
            title: "SingularityNET’s Ben Goertzel hasa grand vision for the future of AI",
        },
        {
            id: 3,
    ...
    return (
        <div className={`${styles.mainContainer} container`}>
            ...
            <div className={styles.titleDesc}>
                <p className="title font-20">Braced dissected sheep, kermani halts, boy note. Quis raucous fall gown, euismod creatures spent, uproar tidings.</p>
            </div>
            <div className={`${styles.mapContainer} contaier_bordered`}>
