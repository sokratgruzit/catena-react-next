    ...
    return (
        <div className={`${styles.boxTitle} container_bordered `}>
            <div className={`${styles.box} container_bordered-child`}>
                ...
                <p className={`${styles.paragraph} `}>Stay up-to-date with the latest CATENA developments such as events, programs and news by joining our social media channels.</p>
